(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=null,t=null,n=!1;function r(){if(e)return e;let n=window.AudioContext??window.webkitAudioContext;return n?(e=new n,t=e.createGain(),t.gain.value=o(),t.connect(e.destination),e):null}function i(){if(n)return;let e=r();e&&(e.state===`suspended`&&e.resume().catch(()=>{}),n=!0)}var a=.6;function o(){return a}function s(e){a=Math.max(0,Math.min(1,e)),t&&(t.gain.value=a)}function c(){return!!e&&e.state===`running`}var l=[261.63,293.66,329.63,392,440,523.25,587.33,659.25];function u(n){let r=e;if(!r||!t||r.state!==`running`)return;let{freq:i,duration:a=.5,attack:o=.02,release:s=.35,type:c=`sine`,gain:l=.5}=n,u=r.createOscillator();u.type=c,u.frequency.value=i;let d=r.createGain();d.gain.setValueAtTime(0,r.currentTime),d.gain.linearRampToValueAtTime(l,r.currentTime+o),d.gain.linearRampToValueAtTime(0,r.currentTime+o+a+s),u.connect(d),d.connect(t),u.start(),u.stop(r.currentTime+o+a+s+.05)}function d(e=440){u({freq:e,duration:.03,attack:.002,release:.08,type:`triangle`,gain:.3})}function ee(n,r=.28){let i=e;if(!i||!t||i.state!==`running`)return null;let a=i.createOscillator();a.type=`sine`,a.frequency.value=n;let o=i.createGain();o.gain.setValueAtTime(0,i.currentTime),o.gain.linearRampToValueAtTime(r,i.currentTime+.05),a.connect(o),o.connect(t),a.start();let s=!1;return{update(e){s||a.frequency.linearRampToValueAtTime(e,i.currentTime+.06)},stop(){s||(s=!0,o.gain.cancelScheduledValues(i.currentTime),o.gain.setValueAtTime(o.gain.value,i.currentTime),o.gain.linearRampToValueAtTime(0,i.currentTime+.15),a.stop(i.currentTime+.2))}}}var f=null;function te(e){if(f)return f;let t=e.sampleRate*.5,n=e.createBuffer(1,t,e.sampleRate),r=n.getChannelData(0);for(let e=0;e<t;e++)r[e]=Math.random()*2-1;return f=n,n}function p(n){let r=e;if(!r||!t||r.state!==`running`)return;let i=r.createBufferSource();i.buffer=te(r);let a=r.createBiquadFilter();a.type=`bandpass`,a.Q.value=8;let o=n?700:2200,s=n?2200:700;a.frequency.setValueAtTime(o,r.currentTime),a.frequency.linearRampToValueAtTime(s,r.currentTime+.35);let c=r.createGain();c.gain.setValueAtTime(0,r.currentTime),c.gain.linearRampToValueAtTime(.18,r.currentTime+.03),c.gain.linearRampToValueAtTime(0,r.currentTime+.38),i.connect(a),a.connect(c),c.connect(t),i.start(),i.stop(r.currentTime+.4)}function m(){let n=e;if(!n||!t||n.state!==`running`)return;let r=n.createBufferSource();r.buffer=te(n);let i=n.createBiquadFilter();i.type=`lowpass`,i.frequency.setValueAtTime(300,n.currentTime),i.frequency.linearRampToValueAtTime(1400,n.currentTime+.25);let a=n.createGain();a.gain.setValueAtTime(0,n.currentTime),a.gain.linearRampToValueAtTime(.14,n.currentTime+.05),a.gain.linearRampToValueAtTime(0,n.currentTime+.3),r.connect(i),i.connect(a),a.connect(t),r.start(),r.stop(n.currentTime+.32)}var ne=`spielkiste:`;function h(e,t,n){try{let r=localStorage.getItem(ne+e);if(!r)return n;let i=JSON.parse(r);return i.v===t?i.data:n}catch{return n}}function g(e,t,n){try{let r={v:t,data:n};localStorage.setItem(ne+e,JSON.stringify(r))}catch{}}function re(){try{let e=[];for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);n?.startsWith(ne)&&e.push(n)}e.forEach(e=>localStorage.removeItem(e))}catch{}}var ie=`settings`,ae=1;function oe(){s(h(ie,ae,{volume:.6}).volume)}function se(e){g(ie,ae,{volume:e})}function ce(e){e.innerHTML=`
    <div class="eltern-panel">
      <h1>Spielkiste</h1>
      <p class="eltern-version">Version 1.0.0 · 9d7e10b</p>
...
<svg viewBox="0 0 120 120" width="100%" height="100%">
  ...
  `,C=e.querySelector(`#kleckseStage`),Ge=We.map(t=>({def:t,el:e.querySelector(`.klecks[data-id="${t.id}"]`),xPct:t.xPct,yPct:t.yPct,grabbed:!1,lastX:0,lastY:0,lastT:0})),Ge.forEach(e=>{Xe(e),Ze(e)})}function Xe(e,t=1,n=1){if(!C)return;let r=C.getBoundingClientRect(),i=e.xPct/100*r.width-e.def.radiusPx,a=e.yPct/100*r.height-e.def.radiusPx;e.el.style.transform=`translate(${i.toFixed(1)}px, ${a.toFixed(1)}px) scale(${t.toFixed(3)}, ${n.toFixed(3)})`}function Ze(e){let t=e.el;qe(t,`pointerdown`,n=>{let r=n;r.preventDefault();try{t.setPointerCapture(r.pointerId)}catch{}e.grabbed=!0,e.lastX=r.clientX,e.lastY=r.clientY,e.lastT=performance.now(),t.classList.add(`grabbed`),u({freq:l[e.def.note%l.length],duration:.35,gain:.35}),$e(e,1.18)}),qe(t,`pointermove`,t=>{if(!e.grabbed||!C)return;let n=t,r=C.getBoundingClientRect(),i=performance.now(),a=Math.max(1,i-e.lastT),o=(n.clientX-e.lastX)/a,s=(n.clientY-e.lastY)/a;e.lastX=n.clientX,e.lastY=n.clientY,e.lastT=i,e.xPct=Je((n.clientX-r.left)/r.width*100,6,94),e.yPct=Je((n.clientY-r.top)/r.height*100,8,92),Qe(e,o,s),tt(e)});function n(n){if(!e.grabbed)return;e.grabbed=!1,t.classList.remove(`grabbed`);let r=n;if(r.pointerId!==void 0)try{t.releasePointerCapture(r.pointerId)}catch{}Xe(e,1,1)}qe(t,`pointerup`,n),qe(t,`pointercancel`,n)}function Qe(e,t,n){let r=Math.min(Math.hypot(t,n)*6,.28),i=Math.atan2(n,t);Xe(e,1+r*Math.abs(Math.cos(i)),1-r*Math.abs(Math.cos(i))*.6+r*Math.abs(Math.sin(i))*.1)}function $e(e,t){Xe(e,t,t),window.setTimeout(()=>{e.el.classList.contains(`grabbed`)||Xe(e,1,1)},160)}function et(e,t){return e<t?`${e}-${t}`:`${t}-${e}`}function tt(e){if(!C)return;let t=C.getBoundingClientRect(),n=e.xPct/100*t.width,r=e.yPct/100*t.height;for(let i of Ge){if(i.def.id===e.def.id)continue;let a=i.xPct/100*t.width,o=i.yPct/100*t.height,s=Math.hypot(n-a,r-o),c=e.def.radiusPx*.75+i.def.radiusPx*.75,d=et(e.def.id,i.def.id);s<c?w.has(d)||(w.add(d),u({freq:l[e.def.note%l.length],duration:.25,gain:.22}),u({freq:l[i.def.note%l.length],duration:.25,gain:.22}),$e(i,1.1)):w.delete(d)}}function nt(){Ke.forEach(e=>e()),Ke=[],Ge=[],C=null,w=new Set}var rt={id:`kleckse`,accent:`#e88a9a`,tileIcon:Ue,mount:Ye,unmount:nt},it=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
  ...
  <circle cx="70" cy="40" r="8" fill="#e88a9a"/>
</svg>`,at=[`#e88a9a`,`#7fb99e`,`#f4c86b`,`#7ea3c9`,`#e0a458`,`#6b5d4a`],ot=`malen`,st=1,T=null,E=null,D=null,ct=at[0],lt=!1,ut=0,dt=0,ft=[],O=null,pt=null;function k(e,t,n){e.addEventListener(t,n),ft.push(()=>e.removeEventListener(t,n))}function mt(e){ft=[],lt=!1,ct=at[0],e.innerHTML=`
    <div class="malen-stage" id="malenStage">
      ...
      <div class="malen-palette" id="malenPalette">
        ${at.map((e,t)=>`<button class="malen-swatch${t===0?` selected`:``}" data-color="${e}" style="--swatch-color:${e}" aria-hidden="true"></button>`).join(``)}
      </div>
  ...
  `,D=e.querySelector(`#malenStage`),T=e.querySelector(`#malenCanvas`),E=T.getContext(`2d`),ht(),gt(),k(T,`pointerdown`,yt),k(T,`pointermove`,bt),k(T,`pointerup`,xt),k(T,`pointercancel`,xt);let t=e.querySelectorAll(`.malen-swatch`);t.forEach(e=>{k(e,`pointerdown`,n=>{n.preventDefault(),ct=e.dataset.color??at[0],t.forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),d(500)})}),k(e.querySelector(`#malenNewSheet`),`pointerdown`,e=>{e.preventDefault(),St()});let n=D.clientWidth,r=D.clientHeight,i=()=>{if(!D)return;let e=D.clientWidth,t=D.clientHeight;(e!==n||t!==r)&&(n=e,r=t,O!==null&&window.clearTimeout(O),O=window.setTimeout(()=>{ht(),gt()},200))};pt=new ResizeObserver(i),pt.observe(D),k(window,`resize`,i),k(window,`orientationchange`,i)}function ht(){if(!T||!D)return;let e=Math.min(window.devicePixelRatio||1,2),t={width:D.clientWidth,height:D.clientHeight};T.width=Math.round(t.width*e),T.height=Math.round(t.height*e),T.style.width=`${t.width}px`,T.style.height=`${t.height}px`,E=T.getContext(`2d`),E&&(E.scale(e,e),E.lineCap=`round`,E.lineJoin=`round`,E.lineWidth=22)}function gt(){let e=h(ot,st,{dataUrl:null});if(!e.dataUrl||!T||!E)return;let t=new Image;t.onload=()=>{if(!E||!T)return;let e=Math.min(window.devicePixelRatio||1,2);E.drawImage(t,0,0,T.width/e,T.height/e)},t.src=e.dataUrl}function _t(){if(T)try{g(ot,st,{dataUrl:T.toDataURL(`image/png`)})}catch{}}function vt(e){let t=T,n=t.getBoundingClientRect(),r=n.width===0?1:t.clientWidth/n.width,i=n.height===0?1:t.clientHeight/n.height;return{x:(e.clientX-n.left)*r,y:(e.clientY-n.top)*i}}function yt(e){let t=e;if(t.preventDefault(),!T||!E)return;try{T.setPointerCapture(t.pointerId)}catch{}lt=!0;let{x:n,y:r}=vt(t);ut=n,dt=r,E.strokeStyle=ct,E.fillStyle=ct,E.beginPath(),E.arc(n,r,E.lineWidth/2,0,Math.PI*2),E.fill()}function bt(e){if(!lt||!E)return;let{x:t,y:n}=vt(e);E.beginPath(),E.moveTo(ut,dt),E.lineTo(t,n),E.stroke(),ut=t,dt=n}function xt(e){if(!lt)return;lt=!1;let t=e;if(T&&t.pointerId!==void 0)try{T.releasePointerCapture(t.pointerId)}catch{}_t()}function St(){if(!T||!E||!D)return;let e=T.toDataURL(`image/png`),t=document.createElement(`img`);t.src=e,t.className=`malen-crumple-overlay`,t.style.width=T.style.width,t.style.height=T.style.height,D.appendChild(t);let n=Math.min(window.devicePixelRatio||1,2);E.clearRect(0,0,T.width/n,T.height/n),g(ot,st,{dataUrl:null}),d(300),t.offsetWidth,t.classList.add(`crumpling`),window.setTimeout(()=>{t.remove()},550)}function Ct(){ft.forEach(e=>e()),ft=[],pt?.disconnect(),pt=null,O!==null&&(window.clearTimeout(O),O=null),T=null,E=null,D=null}var wt={id:`malen`,accent:`#7ea3c9`,tileIcon:it,mount:mt,unmount:Ct},Tt=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
...
</svg>`,Et=[{shape:`square`,color:`#e88a9a`},{shape:`round`,color:`#7fb99e`},{shape:`wide`,color:`#f4c86b`},{shape:`peak`,color:`#7ea3c9`},{shape:`tall`,color:`#e0a458`}],Dt={square:78,round:78,wide:108,peak:78,tall:60},Ot=52,kt=`steine`,At=1,A=[],j=null,M=null,jt=[];function Mt(e,t,n){e.addEventListener(t,n),jt.push(()=>e.removeEventListener(t,n))}function Nt(){g(kt,At,{towers:A})}function Pt(e){let t=Dt[e.shape],n=e.shape===`tall`?4:8,r=e.shape===`peak`?`<div class="steine-roof" style="border-bottom-color:${e.color}"></div>`:``,i=e.shape===`round`?`50px`:`14px`;return`
    <div class="steine-block-body" style="width:${t}px;height:${Ot}px;background:${e.color};border-radius:${i};">
      ${r}
  ...
  `}function Ft(e){jt=[],A=h(kt,At,{towers:[]}).towers,e.innerHTML=`
  ...
  `,j=e.querySelector(`#steineStage`),M=e.querySelector(`#steineTowers`),N(),zt(e),Wt(e)}function N(){M&&(M.innerHTML=``,A.forEach((e,t)=>{let n=document.createElement(`div`);n.className=`steine-tower`+(e.toppled?` toppled`:``),n.style.left=`${e.xPct}%`,n.style.setProperty(`--topple-dir`,String(e.toppleDir));let r=document.createElement(`div`);r.className=`steine-stack`,e.blocks.forEach(e=>{let t=document.createElement(`div`);t.className=`steine-placed-block`,t.innerHTML=Pt(e),r.appendChild(t)}),n.appendChild(r),M.appendChild(n),Lt(n,t)}))}var It=45;function Lt(e,t){let n=0,r=0,i=0;e.addEventListener(`pointerdown`,t=>{let a=t;a.preventDefault(),a.stopPropagation(),n=a.clientX,r=a.clientY,i=0;try{e.setPointerCapture(a.pointerId)}catch{}}),e.addEventListener(`pointermove`,e=>{let t=e;i=Math.max(i,Math.hypot(t.clientX-n,t.clientY-r))}),e.addEventListener(`pointerup`,r=>{let a=r;try{e.releasePointerCapture(a.pointerId)}catch{}let o=A[t];if(!o)return;let s=i>It;if(o.toppled){s||(o.toppled=!1,Nt(),N(),d(600));return}s?(o.toppled=!0,o.toppleDir=a.clientX-n>=0?1:-1,Nt(),N(),m()):Rt(e)}),e.addEventListener(`pointercancel`,t=>{let n=t;try{e.releasePointerCapture(n.pointerId)}catch{}})}function Rt(e){e.classList.remove(`wobble`),e.offsetWidth,e.classList.add(`wobble`),[0,90,180].forEach((e,t)=>{window.setTimeout(()=>{u({freq:500+t*120,duration:.08,attack:.005,release:.1,type:`triangle`,gain:.22})},e)}),window.setTimeout(()=>e.classList.remove(`wobble`),700)}function zt(e){e.querySelectorAll(`.steine-shelf-item`).forEach((e,t)=>{Mt(e,`pointerdown`,n=>Bt(n,e,t))})}function Bt(e,t,n){if(e.preventDefault(),!j)return;try{t.setPointerCapture(e.pointerId)}catch{}let r=Et[n],i=document.createElement(`div`);i.className=`steine-floating-block`,i.innerHTML=Pt(r),j.appendChild(i);let a=(e,t)=>{let n=j.getBoundingClientRect();i.style.left=`${e-n.left}px`,i.style.top=`${t-n.top}px`};a(e.clientX,e.clientY),d(420);let o=!1;function s(e){let t=e;a(t.clientX,t.clientY)}function c(e){if(o)return;o=!0;let n=e;try{t.releasePointerCapture(n.pointerId)}catch{}t.removeEventListener(`pointermove`,s),t.removeEventListener(`pointerup`,c),t.removeEventListener(`pointercancel`,c),i.remove(),Ut(r,n.clientX,n.clientY)}t.addEventListener(`pointermove`,s),t.addEventListener(`pointerup`,c),t.addEventListener(`pointercancel`,c)}var Vt=55,Ht=90;function Ut(e,t,n){if(!j)return;let r=j.getBoundingClientRect(),i=(t-r.left)/r.width*100,a=r.height-24,o=null;for(let e of A){if(e.toppled)continue;let i=r.left+e.xPct/100*r.width,s=r.top+a-e.blocks.length*Ot;if(Math.abs(t-i)<Vt&&Math.abs(n-s)<Ht){o=e;break}}if(o)o.blocks.push(e),Kt(o.blocks.length);else{let t=Math.max(10,Math.min(90,i));A.push({xPct:t,blocks:[e],toppled:!1,toppleDir:1}),Kt(1)}Nt(),N()}function Wt(e){Mt(e.querySelector(`#steineClear`),`pointerdown`,e=>{e.preventDefault(),A.length!==0&&Gt()})}function Gt(){if(!M)return;let e=[...M.querySelectorAll(`.steine-tower`)];e.forEach((e,t)=>{e.style.transitionDelay=`${t*45}ms`,e.offsetWidth,e.classList.add(`wegfegen`)}),m(),window.setTimeout(()=>{A=[],Nt(),N()},500+e.length*45)}function Kt(e){u({freq:Math.max(140,240-e*10),duration:.08,attack:.004,release:.12,type:`sine`,gain:.3})}function qt(){jt.forEach(e=>e()),jt=[],j=null,M=null,A=[]}var Jt={id:`steine`,accent:`#7fb99e`,tileIcon:Tt,mount:Ft,unmount:qt},Yt=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
...
</svg>`,Xt=[`rgba(126, 200, 216, 0.55)`,`rgba(200, 182, 224, 0.55)`,`rgba(244, 200, 107, 0.45)`,`rgba(232, 138, 154, 0.45)`,`rgba(127, 185, 158, 0.5)`],Zt=14,Qt=900,P=null,F=[],I=null,$t=[];function en(e,t,n){e.addEventListener(t,n),F.push(()=>e.removeEventListener(t,n))}function tn(e){F=[],$t=[],e.innerHTML=`
  ...
  `,P=e.querySelector(`#blasenLayer`);let t=e.querySelector(`#blasenWand`);for(let e=0;e<6;e++)nn(.3+Math.random()*.5);I=window.setInterval(()=>nn(),Qt),F.push(()=>{I!==null&&window.clearInterval(I),I=null}),en(P,`pointerdown`,e=>{let t=e,n=t.target.closest(`.blase`);n&&(t.preventDefault(),rn(n))}),en(t,`pointerdown`,e=>{e.preventDefault(),t.classList.remove(`puff`),t.offsetWidth,t.classList.add(`puff`);for(let e=0;e<5;e++)window.setTimeout(()=>nn(0,!0),e*110);u({freq:220,duration:.28,attack:.06,release:.35,type:`sine`,gain:.12})})}function nn(e=0,t=!1){if(!P||P.childElementCount>=Zt)return;let n=42+Math.random()*58,r=Xt[Math.floor(Math.random()*Xt.length)],i=t?14+Math.random()*16:6+Math.random()*88,a=(Math.random()*2-1)*40,o=9e3+Math.random()*5e3,s=document.createElement(`div`);s.className=`blase`,s.style.width=`${n}px`,s.style.height=`${n}px`,s.style.left=`${i}%`,s.style.setProperty(`--tint`,r),s.style.setProperty(`--drift`,`${a}px`),s.style.animationDuration=`${o}ms`,s.style.animationDelay=`${-e*o}ms`,s.innerHTML=`<span class="blase-glanz"></span>`,s.addEventListener(`animationend`,()=>s.remove()),P.appendChild(s)}function rn(e){if(e.classList.contains(`platzt`))return;e.classList.add(`platzt`);let t=l[Math.floor(Math.random()*l.length)];u({freq:t*2,duration:.06,attack:.002,release:.16,type:`sine`,gain:.22});let n=window.setTimeout(()=>e.remove(),340);$t.push(n)}function an(){F.forEach(e=>e()),F=[],I!==null&&(window.clearInterval(I),I=null),$t.forEach(e=>window.clearTimeout(e)),$t=[],P=null}var on={id:`blasen`,accent:`#7ec8d8`,tileIcon:Yt,mount:tn,unmount:an},sn=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
  ...
  <circle cx="84" cy="92" r="13" fill="#7ec8d8"/>
    ...
    </svg>`,dirt:`#7d6b52`,fleck:`#5f5040`}],ln=34,un=.82,L=null,R=null,z=null,B=0,dn=!1,fn=[],V=null,pn=null,mn=[],H=new Map;function U(e,t,n){e.addEventListener(t,n),fn.push(()=>e.removeEventListener(t,n))}function hn(e){fn=[],H.clear(),mn=[],B=0,dn=!1,e.innerHTML=`
  ...
  `,z=e.querySelector(`#putzenStage`),L=e.querySelector(`#putzenCanvas`),gn(e,0),U(L,`pointerdown`,bn),U(L,`pointermove`,xn),U(L,`pointerup`,Sn),U(L,`pointercancel`,Sn),U(e.querySelector(`#putzenNext`),`pointerdown`,t=>{t.preventDefault(),gn(e,B+1),m()});let t=z.clientWidth,n=z.clientHeight,r=()=>{if(!z)return;let e=z.clientWidth,r=z.clientHeight;(e!==t||r!==n)&&(t=e,n=r,V!==null&&window.clearTimeout(V),V=window.setTimeout(()=>_n(),220))};pn=new ResizeObserver(r),pn.observe(z),U(window,`resize`,r),U(window,`orientationchange`,r)}function gn(e,t){B=(t%cn.length+cn.length)%cn.length,dn=!1,z?.classList.remove(`sauber`);let n=e.querySelector(`#putzenMotiv`);n.innerHTML=cn[B].clean,_n()}function _n(){if(!L||!z)return;let e=Math.min(window.devicePixelRatio||1,2),t=z.clientWidth,n=z.clientHeight;L.width=Math.round(t*e),L.height=Math.round(n*e),L.style.width=`${t}px`,L.style.height=`${n}px`,R=L.getContext(`2d`,{willReadFrequently:!0}),R&&(R.scale(e,e),vn(t,n))}function vn(e,t){if(!R)return;let n=cn[B];R.globalCompositeOperation=`source-over`,R.clearRect(0,0,e,t),R.fillStyle=n.dirt,R.fillRect(0,0,e,t),R.fillStyle=n.fleck;for(let n=0;n<140;n++){let n=Math.random()*e,r=Math.random()*t,i=6+Math.random()*26;R.globalAlpha=.18+Math.random()*.3,R.beginPath(),R.ellipse(n,r,i,i*(.6+Math.random()*.7),Math.random()*Math.PI,0,Math.PI*2),R.fill()}R.globalAlpha=1}function yn(e){let t=L,n=t.getBoundingClientRect(),r=n.width===0?1:t.clientWidth/n.width,i=n.height===0?1:t.clientHeight/n.height;return{x:(e.clientX-n.left)*r,y:(e.clientY-n.top)*i}}function bn(e){let t=e;if(t.preventDefault(),!L||!R)return;try{L.setPointerCapture(t.pointerId)}catch{}let n=yn(t);H.set(t.pointerId,n),Cn(n.x,n.y),En()}function xn(e){let t=e,n=H.get(t.pointerId);if(!n||!R)return;let r=yn(t);wn(n.x,n.y,r.x,r.y),H.set(t.pointerId,r),En()}function Sn(e){let t=e;if(H.has(t.pointerId)){if(H.delete(t.pointerId),L)try{L.releasePointerCapture(t.pointerId)}catch{}On()}}function Cn(e,t){R&&(R.globalCompositeOperation=`destination-out`,R.beginPath(),R.arc(e,t,ln,0,Math.PI*2),R.fill())}function wn(e,t,n,r){R&&(R.globalCompositeOperation=`destination-out`,R.lineCap=`round`,R.lineJoin=`round`,R.lineWidth=68,R.beginPath(),R.moveTo(e,t),R.lineTo(n,r),R.stroke())}var Tn=0;function En(){let e=performance.now();e-Tn<130||(Tn=e,u({freq:180+Math.random()*90,duration:.05,attack:.01,release:.1,type:`triangle`,gain:.07}))}function Dn(){if(!L||!R)return 0;let e=0,t=0,n=L.width/24,r=L.height/24;for(let i=0;i<24;i++)for(let a=0;a<24;a++){let o=Math.min(L.width-1,Math.floor(i*n+n/2)),s=Math.min(L.height-1,Math.floor(a*r+r/2));R.getImageData(o,s,1,1).data[3]<40&&e++,t++}return t===0?0:e/t}function On(){if(!dn&&!(Dn()<un)){if(dn=!0,R&&L){let e=Math.min(window.devicePixelRatio||1,2);R.globalCompositeOperation=`destination-out`,R.fillStyle=`#000`,R.fillRect(0,0,L.width/e,L.height/e)}z?.classList.add(`sauber`),[0,130,260].forEach((e,t)=>{let n=window.setTimeout(()=>{u({freq:l[t+3],duration:.3,attack:.01,release:.5,gain:.24})},e);mn.push(n)})}}function kn(){fn.forEach(e=>e()),fn=[],pn?.disconnect(),pn=null,V!==null&&(window.clearTimeout(V),V=null),mn.forEach(e=>window.clearTimeout(e)),mn=[],H.clear(),L=null,R=null,z=null}var An={id:`putzen`,accent:`#7ec8d8`,tileIcon:sn,mount:hn,unmount:kn},jn=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
  ...
  <path d="M74 92 l7 -13 l7 13 z" fill="#7fb99e"/>
    ...
    <div class="sticker-stage" id="stickerStage">
      ...
      <div class="sticker-tray" id="stickerTray">
        ${Mn.map(e=>`<div class="tray-item" data-art="${e.id}" style="width:${e.size*.62}px;height:${e.size*.62}px">${e.svg}</div>`).join(``)}
      </div>
    </div>
  `,G=e.querySelector(`#stickerStage`),K=e.querySelector(`#stickerSzene`),q=e.querySelector(`#stickerTray`),Vn(),q.querySelectorAll(`.tray-item`).forEach(e=>{Ln(e,`pointerdown`,t=>Gn(t,e))})}function Vn(){let e=document.getElementById(`stickerPlatziert`);e&&(e.innerHTML=``,W.forEach((t,n)=>{let r=Rn(t.art),i=document.createElement(`div`);i.className=`sticker`,i.dataset.index=String(n),i.style.width=`${r.size}px`,i.style.height=`${r.size}px`,i.style.left=`${t.xPct}%`,i.style.top=`${t.yPct}%`,i.style.setProperty(`--rot`,`${t.rot}deg`),i.innerHTML=r.svg,e.appendChild(i),Hn(i,n)}))}function Hn(e,t){let n=!1,r=0,i=0,a=0;e.addEventListener(`pointerdown`,t=>{t.preventDefault(),t.stopPropagation(),n=!0,r=0,i=t.clientX,a=t.clientY,e.classList.add(`greift`);try{e.setPointerCapture(t.pointerId)}catch{}}),e.addEventListener(`pointermove`,o=>{if(!n||!K)return;r=Math.max(r,Math.hypot(o.clientX-i,o.clientY-a));let s=K.getBoundingClientRect(),c=W[t];c&&(c.xPct=Wn((o.clientX-s.left)/s.width*100,2,98),c.yPct=Wn((o.clientY-s.top)/s.height*100,2,98),e.style.left=`${c.xPct}%`,e.style.top=`${c.yPct}%`)});let o=i=>{if(n){n=!1,e.classList.remove(`greift`);try{e.releasePointerCapture(i.pointerId)}catch{}if(q&&Un(i.clientX,i.clientY)){W.splice(t,1),zn(),Vn(),d(300);return}r<10&&(e.classList.remove(`wackelt`),e.offsetWidth,e.classList.add(`wackelt`),u({freq:l[Rn(W[t]?.art??Mn[0].id).note%l.length],duration:.3,gain:.28})),zn()}};e.addEventListener(`pointerup`,o),e.addEventListener(`pointercancel`,o)}function Un(e,t){if(!q)return!1;let n=q.getBoundingClientRect();return e>=n.left&&e<=n.right&&t>=n.top&&t<=n.bottom}function Wn(e,t,n){return Math.max(t,Math.min(n,e))}function Gn(e,t){if(e.preventDefault(),!G)return;let n=Rn(t.dataset.art??``);try{t.setPointerCapture(e.pointerId)}catch{}let r=document.createElement(`div`);r.className=`sticker-ghost`,r.style.width=`${n.size}px`,r.style.height=`${n.size}px`,r.innerHTML=n.svg,G.appendChild(r);let i=(e,t)=>{let n=G.getBoundingClientRect();r.style.left=`${e-n.left}px`,r.style.top=`${t-n.top}px`};i(e.clientX,e.clientY),d(560);let a=!1;function o(e){let t=e;i(t.clientX,t.clientY)}function s(e){if(a)return;a=!0;let i=e;try{t.releasePointerCapture(i.pointerId)}catch{}t.removeEventListener(`pointermove`,o),t.removeEventListener(`pointerup`,s),t.removeEventListener(`pointercancel`,s),r.remove(),Kn(n,i.clientX,i.clientY)}t.addEventListener(`pointermove`,o),t.addEventListener(`pointerup`,s),t.addEventListener(`pointercancel`,s)}function Kn(e,t,n){if(!K||Un(t,n))return;let r=K.getBoundingClientRect();n>r.bottom||n<r.top||(W.length>=Fn&&W.shift(),W.push({art:e.id,xPct:Wn((t-r.left)/r.width*100,2,98),yPct:Wn((n-r.top)/r.height*100,2,98),rot:Math.round((Math.random()*2-1)*9)}),zn(),Vn(),u({freq:l[e.note%l.length],duration:.28,gain:.3}))}function qn(){In.forEach(e=>e()),In=[],W=[],G=null,K=null,q=null}var Jn={id:`sticker`,accent:`#9ec99f`,tileIcon:jn,mount:Bn,unmount:qn},Yn=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
...
</svg>`,Xn=`wimmelbild`,Zn=1,Qn={tuerOffen:!1,vorhangOffen:!1,flaggeOben:!1},J={...Qn},$n=[],er=[],Y=new Set;function tr(e,t,n){e.addEventListener(t,n),$n.push(()=>e.removeEventListener(t,n))}function nr(){g(Xn,Zn,J)}function rr(e,t){let n=window.setTimeout(e,t);er.push(n)}function X(e,t,n){let r=e.querySelector(t),i=t;tr(r,`pointerdown`,e=>{e.preventDefault(),!Y.has(i)&&(Y.add(i),r.classList.remove(n.className),r.offsetWidth,r.classList.add(n.className),n.onTrigger?.(r),n.sound?.(),rr(()=>{r.classList.remove(n.className),Y.delete(i)},n.duration))})}function ir(e){J=h(Xn,Zn,{...Qn}),$n=[],er=[],Y=new Set,e.innerHTML=`
  ...
  `,ar(e),or(e),sr(e),cr(e),lr(e),ur(e),dr(e),fr(e),pr(e),mr(e),hr(e),gr(e),_r(e),vr(e)}function ar(e){X(e,`.w-sonne`,{className:`strahlt`,duration:700,sound:()=>{u({freq:1046.5,duration:.35,attack:.01,release:.5,type:`sine`,gain:.22}),u({freq:1567.98,duration:.25,attack:.01,release:.4,type:`sine`,gain:.1})}})}function or(e){X(e,`.w-wolke`,{className:`zieht-vorbei`,duration:2400,sound:()=>m()})}function sr(e){X(e,`.w-schornstein`,{className:`pufft`,duration:1400,sound:()=>u({freq:260,duration:.15,attack:.01,release:.3,type:`sine`,gain:.16})})}function cr(e){let t=e.querySelector(`.w-tuer`);t.classList.toggle(`offen`,J.tuerOffen),tr(t,`pointerdown`,e=>{e.preventDefault(),J.tuerOffen=!J.tuerOffen,t.classList.toggle(`offen`,J.tuerOffen),m(),J.tuerOffen&&(u({freq:587.33,duration:.12,attack:.005,release:.15,type:`triangle`,gain:.2}),rr(()=>u({freq:493.88,duration:.18,attack:.005,release:.25,type:`triangle`,gain:.2}),130)),nr()})}function lr(e){let t=e.querySelector(`.w-fenster`);t.classList.toggle(`offen`,J.vorhangOffen),tr(t,`pointerdown`,e=>{e.preventDefault(),J.vorhangOffen=!J.vorhangOffen,t.classList.toggle(`offen`,J.vorhangOffen),m(),nr()})}function ur(e){X(e,`.w-apfel`,{className:`faellt`,duration:900,sound:()=>u({freq:220,duration:.09,attack:.004,release:.14,type:`sine`,gain:.28})})}function dr(e){X(e,`.w-vogelhaus`,{className:`fliegt`,duration:1600,sound:()=>{[0,90,180].forEach((e,t)=>{rr(()=>u({freq:l[(4+t)%l.length],duration:.14,attack:.005,release:.2,type:`triangle`,gain:.22}),e)})}})}function fr(e){let t=e.querySelector(`.w-schaukel`),n=t.querySelector(`.schaukel-sitz`),r=`schaukel`;tr(t,`pointerdown`,e=>{e.preventDefault(),!Y.has(r)&&(Y.add(r),n.classList.remove(`schwingt`),n.offsetWidth,n.classList.add(`schwingt`),[0,350,700,1050].forEach(e=>{rr(()=>u({freq:380,duration:.05,attack:.005,release:.1,type:`sine`,gain:.1}),e)}),rr(()=>{n.classList.remove(`schwingt`),Y.delete(r)},2200))})}function pr(e){X(e,`.w-biene`,{className:`summt`,duration:1300,sound:()=>u({freq:660,duration:.5,attack:.02,release:.4,type:`sawtooth`,gain:.06})})}function mr(e){X(e,`.w-maulwurfshuegel`,{className:`guckt`,duration:1200,sound:()=>u({freq:180,duration:.12,attack:.005,release:.2,type:`sine`,gain:.24})})}function hr(e){let t=e.querySelector(`.w-briefkasten`);t.classList.toggle(`offen`,J.flaggeOben),tr(t,`pointerdown`,e=>{e.preventDefault(),J.flaggeOben=!J.flaggeOben,t.classList.toggle(`offen`,J.flaggeOben),d(J.flaggeOben?700:500),nr()})}function gr(e){X(e,`.w-frosch`,{className:`huepft`,duration:700,sound:()=>u({freq:200,duration:.1,attack:.004,release:.16,type:`square`,gain:.18})})}function _r(e){X(e,`.w-schnecke`,{className:`streckt`,duration:900,sound:()=>d(520)})}function vr(e){X(e,`.w-marienkaefer`,{className:`fliegt-los`,duration:1100,sound:()=>u({freq:900,duration:.3,attack:.02,release:.3,type:`sawtooth`,gain:.05})})}function yr(){$n.forEach(e=>e()),$n=[],er.forEach(e=>window.clearTimeout(e)),er=[],Y=new Set}var br={id:`wimmelbild`,accent:`#9ec99f`,tileIcon:Yn,mount:ir,unmount:yr};oe();var xr=[He,rt,wt,Jt,on,An,Jn,br],Sr=document.querySelector(`#app`),Cr=`
  <svg viewBox="0 0 96 96" width="40" height="40">
    <path d="M56 26 L34 48 L56 70" fill="none" stroke="#8a7255" stroke-width="8"
      stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
`,wr=18,Tr=2*Math.PI*wr;Sr.innerHTML=`
  ...
  <svg viewBox="0 0 44 44">
    ...
    <circle class="eltern-gate-progress" cx="22" cy="22" r="${wr}" fill="none"
      ...
      stroke-dasharray="${Tr}" stroke-dashoffset="${Tr}"
...
`}</button>
  ...
  <button class="back-button" id="backButton" aria-hidden="true">${Cr}</button>
  <div class="eltern-overlay" id="elternOverlay">
    <div id="elternPanelWrap"></div>
  </div>
  <div class="version-placeholder">v1.0.0 · 9d7e10b</div>
`;var Er=document.querySelector(`#spielzimmer`),Dr=document.querySelector(`#tiles`),Or=document.querySelector(`#toyView`),kr=document.querySelector(`#toyStage`),Ar=document.querySelector(`#backButton`),Z=document.querySelector(`#elternGate`),jr=document.querySelector(`#elternOverlay`),Mr=document.querySelector(`#elternPanelWrap`),Nr=null,Q=!1;function Pr(){Dr.innerHTML=``,xr.forEach((e,t)=>{let n=document.createElement(`button`);n.className=`tile`,n.style.setProperty(`--accent`,e.accent),n.style.animationDelay=`${(t*.7%4.5).toFixed(2)}s`,n.innerHTML=e.tileIcon,n.setAttribute(`aria-hidden`,`true`),n.addEventListener(`pointerdown`,t=>{t.preventDefault(),Fr(e)}),Dr.appendChild(n)})}function Fr(e){Q||Nr||(Q=!0,Nr=e,e.mount(kr),Er.classList.add(`hidden`),Ar.classList.add(`visible`),Or.classList.add(`active`),window.setTimeout(()=>{Q=!1},450))}function Ir(){Q||!Nr||(Q=!0,Or.classList.remove(`active`),Er.classList.remove(`hidden`),Ar.classList.remove(`visible`),window.setTimeout(()=>{Nr?.unmount?.(),kr.innerHTML=``,Nr=null,Q=!1},450))}Ar.addEventListener(`pointerdown`,e=>{e.preventDefault(),Ir()});var Lr=3e3,$=null;function Rr(){$===null&&(Z.classList.add(`charging`),$=window.setTimeout(()=>{$=null,Z.classList.remove(`charging`),Br()},Lr))}function zr(){$!==null&&(window.clearTimeout($),$=null),Z.classList.remove(`charging`)}Z.addEventListener(`pointerdown`,e=>{e.preventDefault(),Rr()}),Z.addEventListener(`pointerup`,zr),Z.addEventListener(`pointercancel`,zr),Z.addEventListener(`pointerleave`,zr);function Br(){ce(Mr),jr.classList.add(`active`)}function Vr(){jr.classList.remove(`active`)}jr.addEventListener(`pointerdown`,e=>{e.target===jr&&Vr()}),document.addEventListener(`click`,e=>{e.target.closest(`.eltern-close`)&&Vr()}),document.addEventListener(`gesturestart`,e=>e.preventDefault()),document.addEventListener(`gesturechange`,e=>e.preventDefault()),document.addEventListener(`dblclick`,e=>e.preventDefault()),document.addEventListener(`contextmenu`,e=>e.preventDefault());var Hr=!1;document.addEventListener(`pointerdown`,()=>{i(),Hr||(Hr=!0,window.setTimeout(()=>{c()&&u({freq:523.25,duration:.15,gain:.25})},80))},{once:!1}),Pr();