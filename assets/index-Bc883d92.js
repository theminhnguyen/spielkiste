(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=null,t=null,n=!1,r=null,i=null;function a(){if(e)return e;try{let r=window.AudioContext??window.webkitAudioContext;return r?(e=new r,e.onstatechange=()=>{e?.state===`running`&&(n=!0)},t=e.createGain(),t.gain.value=u(),t.connect(e.destination),e):(i=`AudioContext wird vom Browser nicht unterstützt`,null)}catch(t){return i=t instanceof Error?t.message:String(t),e=null,null}}function o(){let e=new Uint8Array(45),t=new DataView(e.buffer),n=(e,n)=>{for(let r=0;r<n.length;r++)t.setUint8(e+r,n.charCodeAt(r))};n(0,`RIFF`),t.setUint32(4,37,!0),n(8,`WAVE`),n(12,`fmt `),t.setUint32(16,16,!0),t.setUint16(20,1,!0),t.setUint16(22,1,!0),t.setUint32(24,8e3,!0),t.setUint32(28,8e3,!0),t.setUint16(32,1,!0),t.setUint16(34,8,!0),n(36,`data`),t.setUint32(40,1,!0),t.setUint8(44,128);let r=``;return e.forEach(e=>r+=String.fromCharCode(e)),`data:audio/wav;base64,${btoa(r)}`}function s(){if(!n)try{let e=a();if(!e)return;e.state===`running`?n=!0:e.state===`closed`?i=`AudioContext im Zustand "${e.state}"`:e.resume().then(()=>{e.state===`running`&&(n=!0)}).catch(t=>{i=`resume() abgelehnt (Zustand war "${e.state}"): ${t instanceof Error?t.message:String(t)}`}),r||(r=new Audio(o()),r.volume=.01,r.setAttribute(`playsinline`,`true`));try{r.currentTime=0}catch{}r.play().catch(e=>{i=`stilles <audio> abgelehnt: ${e instanceof Error?e.message:String(e)}`})}catch(e){i=e instanceof Error?`${e.name}: ${e.message}`:String(e)}}function c(){let t=[];t.push(e?`Status: ${e.state}`:`Status: noch nicht gestartet`),t.push(n?`freigeschaltet: ja`:`freigeschaltet: nein`),t.push(`Lautstärke: ${Math.round(l*100)}%`);let r=!!(window.AudioContext??window.webkitAudioContext);return t.push(`AudioContext unterstützt: ${r?`ja`:`nein`}`),i&&t.push(`letzter Fehler: ${i}`),t.join(` · `)}var l=.6;function u(){return l}function d(e){l=Math.max(0,Math.min(1,e)),t&&(t.gain.value=l)}function ee(){return!!e&&e.state===`running`}var f=[261.63,293.66,329.63,392,440,523.25,587.33,659.25];function p(n){let r=e;if(!r||!t||r.state!==`running`)return;let{freq:i,duration:a=.5,attack:o=.02,release:s=.35,type:c=`sine`,gain:l=.5}=n,u=r.createOscillator();u.type=c,u.frequency.value=i;let d=r.createGain();d.gain.setValueAtTime(0,r.currentTime),d.gain.linearRampToValueAtTime(l,r.currentTime+o),d.gain.linearRampToValueAtTime(0,r.currentTime+o+a+s),u.connect(d),d.connect(t),u.start(),u.stop(r.currentTime+o+a+s+.05)}function m(e=440){p({freq:e,duration:.03,attack:.002,release:.08,type:`triangle`,gain:.3})}function te(n,r=.28){let i=e;if(!i||!t||i.state!==`running`)return null;let a=i.createOscillator();a.type=`sine`,a.frequency.value=n;let o=i.createGain();o.gain.setValueAtTime(0,i.currentTime),o.gain.linearRampToValueAtTime(r,i.currentTime+.05),a.connect(o),o.connect(t),a.start();let s=!1;return{update(e){s||a.frequency.linearRampToValueAtTime(e,i.currentTime+.06)},stop(){s||(s=!0,o.gain.cancelScheduledValues(i.currentTime),o.gain.setValueAtTime(o.gain.value,i.currentTime),o.gain.linearRampToValueAtTime(0,i.currentTime+.15),a.stop(i.currentTime+.2))}}}var ne=null;function re(e){if(ne)return ne;let t=e.sampleRate*.5,n=e.createBuffer(1,t,e.sampleRate),r=n.getChannelData(0);for(let e=0;e<t;e++)r[e]=Math.random()*2-1;return ne=n,n}function ie(n){let r=e;if(!r||!t||r.state!==`running`)return;let i=r.createBufferSource();i.buffer=re(r);let a=r.createBiquadFilter();a.type=`bandpass`,a.Q.value=8;let o=n?700:2200,s=n?2200:700;a.frequency.setValueAtTime(o,r.currentTime),a.frequency.linearRampToValueAtTime(s,r.currentTime+.35);let c=r.createGain();c.gain.setValueAtTime(0,r.currentTime),c.gain.linearRampToValueAtTime(.18,r.currentTime+.03),c.gain.linearRampToValueAtTime(0,r.currentTime+.38),i.connect(a),a.connect(c),c.connect(t),i.start(),i.stop(r.currentTime+.4)}function h(){let n=e;if(!n||!t||n.state!==`running`)return;let r=n.createBufferSource();r.buffer=re(n);let i=n.createBiquadFilter();i.type=`lowpass`,i.frequency.setValueAtTime(300,n.currentTime),i.frequency.linearRampToValueAtTime(1400,n.currentTime+.25);let a=n.createGain();a.gain.setValueAtTime(0,n.currentTime),a.gain.linearRampToValueAtTime(.14,n.currentTime+.05),a.gain.linearRampToValueAtTime(0,n.currentTime+.3),r.connect(i),i.connect(a),a.connect(t),r.start(),r.stop(n.currentTime+.32)}var ae=`spielkiste:`;function g(e,t,n){try{let r=localStorage.getItem(ae+e);if(!r)return n;let i=JSON.parse(r);return i.v===t?i.data:n}catch{return n}}function _(e,t,n){try{let r={v:t,data:n};localStorage.setItem(ae+e,JSON.stringify(r))}catch{}}function oe(){try{let e=[];for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);n?.startsWith(ae)&&e.push(n)}e.forEach(e=>localStorage.removeItem(e))}catch{}}var se=`settings`,ce=1;function le(){d(g(se,ce,{volume:.6}).volume)}function ue(e){_(se,ce,{volume:e})}function de(e){e.innerHTML=`
    <div class="eltern-panel">
      <h1>Spielkiste</h1>
      <p class="eltern-version">Version 1.0.6 · 0396163</p>
...
</svg>`,j=[{id:`kreis`,color:`#e88a9a`,note:0,restX:14,restY:80,path:`<circle cx="50" cy="50" r="42"/>`,svg:`<svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="42" fill="#e88a9a"/><circle cx="38" cy="46" r="5" fill="#4a4032"/><circle cx="62" cy="46" r="5" fill="#4a4032"/><path d="M38 60 Q50 68 62 60" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/></svg>`},{id:`quadrat`,color:`#7fb99e`,note:2,restX:33,restY:88,path:`<rect x="8" y="8" width="84" height="84" rx="16"/>`,svg:`<svg viewBox="0 0 100 100"><rect x="8" y="8" width="84" height="84" rx="16" fill="#7fb99e"/><circle cx="38" cy="46" r="5" fill="#4a4032"/><circle cx="62" cy="46" r="5" fill="#4a4032"/><path d="M38 60 Q50 68 62 60" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/></svg>`},{id:`dreieck`,color:`#f4c86b`,note:4,restX:52,restY:80,path:`<path d="M50 10 L92 88 L8 88 Z" stroke-linejoin="round"/>`,svg:`<svg viewBox="0 0 100 100"><path d="M50 10 L92 88 L8 88 Z" fill="#f4c86b" stroke-linejoin="round"/><circle cx="40" cy="66" r="4.5" fill="#4a4032"/><circle cx="60" cy="66" r="4.5" fill="#4a4032"/><path d="M40 76 Q50 82 60 76" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/></svg>`},{id:`stern`,color:`#7ea3c9`,note:5,restX:71,restY:88,path:`<path d="M50 6 L62 37 L96 37 L68 57 L79 90 L50 70 L21 90 L32 57 L4 37 L38 37 Z"/>`,svg:`<svg viewBox="0 0 100 100"><path d="M50 6 L62 37 L96 37 L68 57 L79 90 L50 70 L21 90 L32 57 L4 37 L38 37 Z" fill="#7ea3c9"/><circle cx="42" cy="48" r="4" fill="#4a4032"/><circle cx="58" cy="48" r="4" fill="#4a4032"/><path d="M42 58 Q50 63 58 58" stroke="#4a4032" stroke-width="2.5" fill="none" stroke-linecap="round"/></svg>`},{id:`herz`,color:`#c896d8`,note:7,restX:88,restY:78,path:`<path d="M50 92 C20 67 4 46 4 28 C4 12 17 2 32 2 C42 2 48 9 50 16 C52 9 58 2 68 2 C83 2 96 12 96 28 C96 46 80 67 50 92 Z"/>`,svg:`<svg viewBox="0 0 100 100"><path d="M50 92 C20 67 4 46 4 28 C4 12 17 2 32 2 C42 2 48 9 50 16 C52 9 58 2 68 2 C83 2 96 12 96 28 C96 46 80 67 50 92 Z" fill="#c896d8"/><circle cx="40" cy="34" r="4.5" fill="#4a4032"/><circle cx="60" cy="34" r="4.5" fill="#4a4032"/><path d="M40 44 Q50 50 60 44" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/></svg>`}],Mt=`sortierer`,Nt=1;function Pt(){return j.map(e=>({id:e.id,xPct:e.restX,yPct:e.restY,placed:!1}))}var Ft={shapes:Pt()},M=null,It=[],Lt=null,Rt=new Map;function N(e,t,n){e.addEventListener(t,n),It.push(()=>e.removeEventListener(t,n))}function P(e){return Ft.shapes.find(t=>t.id===e)??{id:e,xPct:50,yPct:80,placed:!1}}function zt(){_(Mt,Nt,Ft)}function Bt(e){It=[],Rt=new Map;let t=g(Mt,Nt,{shapes:Pt()});Ft={shapes:j.map(e=>t.shapes.find(t=>t.id===e.id)??{id:e.id,xPct:e.restX,yPct:e.restY,placed:!1})},e.innerHTML=`
...
<svg viewBox="0 0 120 120" width="100%" height="100%">
  ...
  `,Bn=e.querySelector(`#stickerStage`),G=e.querySelector(`#stickerSzene`),K=e.querySelector(`#stickerTray`),Yn(),Zn(e),K.querySelectorAll(`.tray-item`).forEach(e=>{Wn(e,`pointerdown`,t=>tr(t,e))}),Hn=new ResizeObserver(()=>{let e=document.getElementById(`stickerPlatziert`);e&&e.querySelectorAll(`.sticker`).forEach(e=>{let t=Number(e.dataset.index);if(t===Un)return;let n=W[t];n&&Jn(e,n.xPct,n.yPct)})}),Hn.observe(G)}function Jn(e,t,n){if(!G)return;let r=G.getBoundingClientRect();e.style.setProperty(`--tx`,`${(t/100*r.width).toFixed(1)}px`),e.style.setProperty(`--ty`,`${(n/100*r.height).toFixed(1)}px`)}function Yn(){let e=document.getElementById(`stickerPlatziert`);e&&(e.innerHTML=``,W.forEach((t,n)=>{let r=Gn(t.art),i=document.createElement(`div`);i.className=`sticker`,i.dataset.index=String(n),i.style.width=`${r.size}px`,i.style.height=`${r.size}px`,Jn(i,t.xPct,t.yPct),i.style.setProperty(`--rot`,`${t.rot}deg`),i.innerHTML=r.svg,e.appendChild(i),Xn(i,n)}))}function Xn(e,t){let n=!1,r=0,i=0,a=0;e.addEventListener(`pointerdown`,o=>{o.preventDefault(),o.stopPropagation(),n=!0,Un=t,r=0,i=o.clientX,a=o.clientY,e.classList.add(`greift`);try{e.setPointerCapture(o.pointerId)}catch{}}),e.addEventListener(`pointermove`,o=>{if(!n||!G)return;r=Math.max(r,Math.hypot(o.clientX-i,o.clientY-a));let s=G.getBoundingClientRect(),c=W[t];c&&(c.xPct=er((o.clientX-s.left)/s.width*100,2,98),c.yPct=er((o.clientY-s.top)/s.height*100,2,98),Jn(e,c.xPct,c.yPct))});let o=i=>{if(n){n=!1,Un=null,e.classList.remove(`greift`);try{e.releasePointerCapture(i.pointerId)}catch{}if(K&&$n(i.clientX,i.clientY)){W.splice(t,1),Kn(),Yn(),m(300);return}r<10&&(e.classList.remove(`wackelt`),e.offsetWidth,e.classList.add(`wackelt`),p({freq:f[Gn(W[t]?.art??In[0].id).note%f.length],duration:.3,gain:.28})),Kn()}};e.addEventListener(`pointerup`,o),e.addEventListener(`pointercancel`,o)}function Zn(e){Wn(e.querySelector(`#stickerClear`),`pointerdown`,e=>{e.preventDefault(),W.length!==0&&Qn()})}function Qn(){let e=document.getElementById(`stickerPlatziert`);if(!e)return;let t=[...e.querySelectorAll(`.sticker`)];t.forEach((e,t)=>{e.style.transitionDelay=`${Math.min(t*25,500)}ms`,e.offsetWidth,e.classList.add(`wegfegen`)}),h(),window.setTimeout(()=>{W=[],Kn(),Yn()},500+Math.min(t.length*25,500))}function $n(e,t){if(!K)return!1;let n=K.getBoundingClientRect();return e>=n.left&&e<=n.right&&t>=n.top&&t<=n.bottom}function er(e,t,n){return Math.max(t,Math.min(n,e))}function tr(e,t){if(e.preventDefault(),!Bn)return;let n=Gn(t.dataset.art??``);try{t.setPointerCapture(e.pointerId)}catch{}let r=document.createElement(`div`);r.className=`sticker-ghost`,r.style.width=`${n.size}px`,r.style.height=`${n.size}px`,r.innerHTML=n.svg,Bn.appendChild(r);let i=(e,t)=>{let n=Bn.getBoundingClientRect();r.style.setProperty(`--tx`,`${(e-n.left).toFixed(1)}px`),r.style.setProperty(`--ty`,`${(t-n.top).toFixed(1)}px`)};i(e.clientX,e.clientY),m(560);let a=!1;function o(e){let t=e;i(t.clientX,t.clientY)}function s(e){if(a)return;a=!0;let i=e;try{t.releasePointerCapture(i.pointerId)}catch{}t.removeEventListener(`pointermove`,o),t.removeEventListener(`pointerup`,s),t.removeEventListener(`pointercancel`,s),r.remove(),nr(n,i.clientX,i.clientY)}t.addEventListener(`pointermove`,o),t.addEventListener(`pointerup`,s),t.addEventListener(`pointercancel`,s)}function nr(e,t,n){if(!G||$n(t,n))return;let r=G.getBoundingClientRect();n>r.bottom||n<r.top||(W.length>=zn&&W.shift(),W.push({art:e.id,xPct:er((t-r.left)/r.width*100,2,98),yPct:er((n-r.top)/r.height*100,2,98),rot:Math.round((Math.random()*2-1)*9)}),Kn(),Yn(),p({freq:f[e.note%f.length],duration:.28,gain:.3}))}function rr(){Vn.forEach(e=>e()),Vn=[],Hn?.disconnect(),Hn=null,Un=null,W=[],Bn=null,G=null,K=null}var ir={id:`sticker`,accent:`#9ec99f`,tileIcon:Fn,mount:qn,unmount:rr},ar=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
...
</svg>`,or=`wimmelbild`,sr=1,cr={tuerOffen:!1,vorhangOffen:!1,flaggeOben:!1},q={...cr},lr=[],ur=[],J=new Set;function dr(e,t,n){e.addEventListener(t,n),lr.push(()=>e.removeEventListener(t,n))}function fr(){_(or,sr,q)}function pr(e,t){let n=window.setTimeout(e,t);ur.push(n)}function Y(e,t,n){let r=e.querySelector(t),i=t;dr(r,`pointerdown`,e=>{e.preventDefault(),!J.has(i)&&(J.add(i),r.classList.remove(n.className),r.offsetWidth,r.classList.add(n.className),n.onTrigger?.(r),n.sound?.(),pr(()=>{r.classList.remove(n.className),J.delete(i)},n.duration))})}function mr(e){q=g(or,sr,{...cr}),lr=[],ur=[],J=new Set,e.innerHTML=`
  ...
  `,hr(e),gr(e),_r(e),vr(e),yr(e),br(e),xr(e),Sr(e),Cr(e),wr(e),Tr(e),Er(e),Dr(e),Or(e)}function hr(e){Y(e,`.w-sonne`,{className:`strahlt`,duration:700,sound:()=>{p({freq:1046.5,duration:.35,attack:.01,release:.5,type:`sine`,gain:.22}),p({freq:1567.98,duration:.25,attack:.01,release:.4,type:`sine`,gain:.1})}})}function gr(e){Y(e,`.w-wolke`,{className:`zieht-vorbei`,duration:2400,sound:()=>h()})}function _r(e){Y(e,`.w-schornstein`,{className:`pufft`,duration:1400,sound:()=>p({freq:260,duration:.15,attack:.01,release:.3,type:`sine`,gain:.16})})}function vr(e){let t=e.querySelector(`.w-tuer`);t.classList.toggle(`offen`,q.tuerOffen),dr(t,`pointerdown`,e=>{e.preventDefault(),q.tuerOffen=!q.tuerOffen,t.classList.toggle(`offen`,q.tuerOffen),h(),q.tuerOffen&&(p({freq:587.33,duration:.12,attack:.005,release:.15,type:`triangle`,gain:.2}),pr(()=>p({freq:493.88,duration:.18,attack:.005,release:.25,type:`triangle`,gain:.2}),130)),fr()})}function yr(e){let t=e.querySelector(`.w-fenster`);t.classList.toggle(`offen`,q.vorhangOffen),dr(t,`pointerdown`,e=>{e.preventDefault(),q.vorhangOffen=!q.vorhangOffen,t.classList.toggle(`offen`,q.vorhangOffen),h(),fr()})}function br(e){Y(e,`.w-apfel`,{className:`faellt`,duration:900,sound:()=>p({freq:220,duration:.09,attack:.004,release:.14,type:`sine`,gain:.28})})}function xr(e){Y(e,`.w-vogelhaus`,{className:`fliegt`,duration:1600,sound:()=>{[0,90,180].forEach((e,t)=>{pr(()=>p({freq:f[(4+t)%f.length],duration:.14,attack:.005,release:.2,type:`triangle`,gain:.22}),e)})}})}function Sr(e){let t=e.querySelector(`.w-schaukel`),n=t.querySelector(`.schaukel-sitz`),r=`schaukel`;dr(t,`pointerdown`,e=>{e.preventDefault(),!J.has(r)&&(J.add(r),n.classList.remove(`schwingt`),n.offsetWidth,n.classList.add(`schwingt`),[0,350,700,1050].forEach(e=>{pr(()=>p({freq:380,duration:.05,attack:.005,release:.1,type:`sine`,gain:.1}),e)}),pr(()=>{n.classList.remove(`schwingt`),J.delete(r)},2200))})}function Cr(e){Y(e,`.w-biene`,{className:`summt`,duration:1300,sound:()=>p({freq:660,duration:.5,attack:.02,release:.4,type:`sawtooth`,gain:.06})})}function wr(e){Y(e,`.w-maulwurfshuegel`,{className:`guckt`,duration:1200,sound:()=>p({freq:180,duration:.12,attack:.005,release:.2,type:`sine`,gain:.24})})}function Tr(e){let t=e.querySelector(`.w-briefkasten`);t.classList.toggle(`offen`,q.flaggeOben),dr(t,`pointerdown`,e=>{e.preventDefault(),q.flaggeOben=!q.flaggeOben,t.classList.toggle(`offen`,q.flaggeOben),m(q.flaggeOben?700:500),fr()})}function Er(e){Y(e,`.w-frosch`,{className:`huepft`,duration:700,sound:()=>p({freq:200,duration:.1,attack:.004,release:.16,type:`square`,gain:.18})})}function Dr(e){Y(e,`.w-schnecke`,{className:`streckt`,duration:900,sound:()=>m(520)})}function Or(e){Y(e,`.w-marienkaefer`,{className:`fliegt-los`,duration:1100,sound:()=>p({freq:900,duration:.3,attack:.02,release:.3,type:`sawtooth`,gain:.05})})}function kr(){lr.forEach(e=>e()),lr=[],ur.forEach(e=>window.clearTimeout(e)),ur=[],J=new Set}var Ar={id:`wimmelbild`,accent:`#9ec99f`,tileIcon:ar,mount:mr,unmount:kr},jr=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
...
</svg>`,Mr=[{id:`baer`,bettFarbe:`#e0a458`,wach:`<svg viewBox="0 0 100 100"><circle cx="50" cy="58" r="30" fill="#c9a37e"/><circle cx="24" cy="34" r="12" fill="#c9a37e"/><circle cx="76" cy="34" r="12" fill="#c9a37e"/><circle cx="40" cy="56" r="4" fill="#4a4032"/><circle cx="60" cy="56" r="4" fill="#4a4032"/><ellipse cx="50" cy="68" rx="8" ry="5" fill="#8a7255"/></svg>`,schlaeft:`<svg viewBox="0 0 100 100"><circle cx="50" cy="58" r="30" fill="#c9a37e"/><circle cx="24" cy="34" r="12" fill="#c9a37e"/><circle cx="76" cy="34" r="12" fill="#c9a37e"/><path d="M34 56 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M54 56 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><ellipse cx="50" cy="68" rx="8" ry="5" fill="#8a7255"/></svg>`},{id:`hase`,bettFarbe:`#e88a9a`,wach:`<svg viewBox="0 0 100 100"><ellipse cx="50" cy="62" rx="26" ry="26" fill="#f3e7db"/><ellipse cx="38" cy="24" rx="8" ry="20" fill="#f3e7db"/><ellipse cx="62" cy="24" rx="8" ry="20" fill="#f3e7db"/><ellipse cx="38" cy="26" rx="4" ry="13" fill="#f2b8c6"/><ellipse cx="62" cy="26" rx="4" ry="13" fill="#f2b8c6"/><circle cx="41" cy="58" r="4" fill="#4a4032"/><circle cx="59" cy="58" r="4" fill="#4a4032"/><ellipse cx="50" cy="68" rx="5" ry="3.5" fill="#e88a9a"/></svg>`,schlaeft:`<svg viewBox="0 0 100 100"><ellipse cx="50" cy="62" rx="26" ry="26" fill="#f3e7db"/><ellipse cx="38" cy="24" rx="8" ry="20" fill="#f3e7db"/><ellipse cx="62" cy="24" rx="8" ry="20" fill="#f3e7db"/><ellipse cx="38" cy="26" rx="4" ry="13" fill="#f2b8c6"/><ellipse cx="62" cy="26" rx="4" ry="13" fill="#f2b8c6"/><path d="M35 58 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M53 58 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><ellipse cx="50" cy="68" rx="5" ry="3.5" fill="#e88a9a"/></svg>`},{id:`katze`,bettFarbe:`#7ea3c9`,wach:`<svg viewBox="0 0 100 100"><ellipse cx="50" cy="60" rx="26" ry="24" fill="#e0a458"/><path d="M26 46 L20 18 L46 40 Z" fill="#e0a458"/><path d="M74 46 L80 18 L54 40 Z" fill="#e0a458"/><path d="M28 42 L24 24 L40 38 Z" fill="#f2b8c6"/><path d="M72 42 L76 24 L60 38 Z" fill="#f2b8c6"/><circle cx="40" cy="58" r="4" fill="#4a4032"/><circle cx="60" cy="58" r="4" fill="#4a4032"/><path d="M42 68 Q50 73 58 68" stroke="#8a5a2e" stroke-width="2.5" fill="none" stroke-linecap="round"/></svg>`,schlaeft:`<svg viewBox="0 0 100 100"><ellipse cx="50" cy="60" rx="26" ry="24" fill="#e0a458"/><path d="M26 46 L20 18 L46 40 Z" fill="#e0a458"/><path d="M74 46 L80 18 L54 40 Z" fill="#e0a458"/><path d="M28 42 L24 24 L40 38 Z" fill="#f2b8c6"/><path d="M72 42 L76 24 L60 38 Z" fill="#f2b8c6"/><path d="M34 58 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M54 58 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M42 68 Q50 71 58 68" stroke="#8a5a2e" stroke-width="2.5" fill="none" stroke-linecap="round"/></svg>`}],Nr=`gutenacht`,Pr=1,Fr={lampeAn:!0,schlaeft:[!1,!1,!1]},X={...Fr},Ir=[],Lr=[];function Rr(e,t){let n=window.setTimeout(e,t);Lr.push(n)}function zr(e,t,n){e.addEventListener(t,n),Ir.push(()=>e.removeEventListener(t,n))}function Br(){_(Nr,Pr,X)}function Vr(e){X=g(Nr,Pr,{...Fr,schlaeft:[...Fr.schlaeft]}),Ir=[],e.innerHTML=`
  ...
  `;let t=e.querySelector(`#nachtSzene`);t.classList.toggle(`dunkel`,!X.lampeAn),Hr(e,t),Ur(e)}function Hr(e,t){zr(e.querySelector(`.n-lampe`),`pointerdown`,e=>{e.preventDefault(),X.lampeAn=!X.lampeAn,t.classList.toggle(`dunkel`,!X.lampeAn),p({freq:X.lampeAn?480:320,duration:.18,attack:.01,release:.3,type:`sine`,gain:.18}),Br()})}function Ur(e){e.querySelectorAll(`.n-tier`).forEach(e=>{let t=Number(e.dataset.idx);zr(e,`pointerdown`,n=>{n.preventDefault();let r=!X.schlaeft[t];X.schlaeft[t]=r,e.classList.toggle(`schlaeft`,r),e.closest(`.n-bett`)?.classList.toggle(`schlaeft`,r),r?(h(),p({freq:392,duration:.2,attack:.01,release:.4,type:`sine`,gain:.16}),Rr(()=>{p({freq:294,duration:.3,attack:.01,release:.5,type:`sine`,gain:.14})},220)):(p({freq:440,duration:.1,attack:.005,release:.2,type:`triangle`,gain:.2}),Rr(()=>{p({freq:587.33,duration:.16,attack:.005,release:.25,type:`triangle`,gain:.2})},110)),Br()})})}function Wr(){Ir.forEach(e=>e()),Ir=[],Lr.forEach(e=>window.clearTimeout(e)),Lr=[],X={...Fr,schlaeft:[...Fr.schlaeft]}}var Gr={id:`gutenacht`,accent:`#7ea3c9`,tileIcon:jr,mount:Vr,unmount:Wr};le();var Kr=[Ge,lt,At,Xt,ln,Pn,ir,Ar,Gr],qr=document.querySelector(`#app`),Jr=`
  <svg viewBox="0 0 96 96" width="40" height="40">
    <path d="M56 26 L34 48 L56 70" fill="none" stroke="#8a7255" stroke-width="8"
      stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
`,Yr=18,Xr=2*Math.PI*Yr;qr.innerHTML=`
  <div class="spielzimmer" id="spielzimmer">
    <div class="tiles" id="tiles"></div>
    <button class="eltern-gate" id="elternGate" aria-hidden="true">${`
  <svg viewBox="0 0 44 44">
    <circle cx="22" cy="22" r="${Yr}" fill="none" stroke="#8a7255" stroke-width="3" opacity="0.25"/>
    <circle class="eltern-gate-progress" cx="22" cy="22" r="${Yr}" fill="none"
      stroke="#8a7255" stroke-width="3" stroke-linecap="round"
      stroke-dasharray="${Xr}" stroke-dashoffset="${Xr}"
...
`}</button>
  ...
  <button class="back-button" id="backButton" aria-hidden="true">${Jr}</button>
  <div class="eltern-overlay" id="elternOverlay">
    <div id="elternPanelWrap"></div>
  </div>
  <div class="version-placeholder">v1.0.6 · 0396163</div>
`;var Zr=document.querySelector(`#spielzimmer`),Qr=document.querySelector(`#tiles`),$r=document.querySelector(`#toyView`),ei=document.querySelector(`#toyStage`),ti=document.querySelector(`#backButton`),Z=document.querySelector(`#elternGate`),ni=document.querySelector(`#elternOverlay`),ri=document.querySelector(`#elternPanelWrap`),ii=null,Q=!1;function ai(){Qr.innerHTML=``,Kr.forEach((e,t)=>{let n=document.createElement(`button`);n.className=`tile`,n.style.setProperty(`--accent`,e.accent),n.style.animationDelay=`${(t*.7%4.5).toFixed(2)}s`,n.innerHTML=e.tileIcon,n.setAttribute(`aria-hidden`,`true`),n.addEventListener(`pointerdown`,t=>{t.preventDefault(),oi(e)}),Qr.appendChild(n)})}function oi(e){Q||ii||(Q=!0,ii=e,e.mount(ei),Zr.classList.add(`hidden`),ti.classList.add(`visible`),$r.classList.add(`active`),window.setTimeout(()=>{Q=!1},450))}function si(){Q||!ii||(Q=!0,$r.classList.remove(`active`),Zr.classList.remove(`hidden`),ti.classList.remove(`visible`),window.setTimeout(()=>{ii?.unmount?.(),ei.innerHTML=``,ii=null,Q=!1},450))}ti.addEventListener(`pointerdown`,e=>{e.preventDefault(),si()});var ci=3e3,$=null;function li(){$===null&&(Z.classList.add(`charging`),$=window.setTimeout(()=>{$=null,Z.classList.remove(`charging`),di()},ci))}function ui(){$!==null&&(window.clearTimeout($),$=null),Z.classList.remove(`charging`)}Z.addEventListener(`pointerdown`,e=>{e.preventDefault(),li()}),Z.addEventListener(`pointerup`,ui),Z.addEventListener(`pointercancel`,ui),Z.addEventListener(`pointerleave`,ui);function di(){de(ri),ni.classList.add(`active`)}function fi(){ni.classList.remove(`active`)}ni.addEventListener(`pointerdown`,e=>{e.target===ni&&fi()}),document.addEventListener(`click`,e=>{e.target.closest(`.eltern-close`)&&fi()}),document.addEventListener(`gesturestart`,e=>e.preventDefault()),document.addEventListener(`gesturechange`,e=>e.preventDefault()),document.addEventListener(`dblclick`,e=>e.preventDefault()),document.addEventListener(`contextmenu`,e=>e.preventDefault());var pi=!1;document.addEventListener(`pointerdown`,()=>{s(),pi||(pi=!0,window.setTimeout(()=>{ee()&&p({freq:523.25,duration:.15,gain:.25})},80))},{once:!1}),ai();