...
<svg viewBox="0 0 120 120" width="100%" height="100%">
  ...
  `,w=e.querySelector(`#kleckseStage`),Ke=Ge.map(t=>({def:t,el:e.querySelector(`.klecks[data-id="${t.id}"]`),xPct:t.xPct,yPct:t.yPct,grabbed:!1,lastX:0,lastY:0,lastT:0})),Ke.forEach(e=>{T(e),$e(e)}),Ye=new ResizeObserver(()=>{Ke.forEach(e=>{e.grabbed||T(e)})}),Ye.observe(w)}function T(e,t=1,n=1){if(!w)return;let r=w.getBoundingClientRect(),i=e.xPct/100*r.width-e.def.radiusPx,a=e.yPct/100*r.height-e.def.radiusPx;e.el.style.transform=`translate(${i.toFixed(1)}px, ${a.toFixed(1)}px) scale(${t.toFixed(3)}, ${n.toFixed(3)})`}function $e(e){let t=e.el;Xe(t,`pointerdown`,n=>{let r=n;r.preventDefault();try{t.setPointerCapture(r.pointerId)}catch{}e.grabbed=!0,e.lastX=r.clientX,e.lastY=r.clientY,e.lastT=performance.now(),t.classList.add(`grabbed`),f({freq:d[e.def.note%d.length],duration:.35,gain:.35}),tt(e,1.18),nt(e)}),Xe(t,`pointermove`,t=>{if(!e.grabbed||!w)return;let n=t,r=w.getBoundingClientRect(),i=performance.now(),a=Math.max(1,i-e.lastT),o=(n.clientX-e.lastX)/a,s=(n.clientY-e.lastY)/a;e.lastX=n.clientX,e.lastY=n.clientY,e.lastT=i,e.xPct=Ze((n.clientX-r.left)/r.width*100,6,94),e.yPct=Ze((n.clientY-r.top)/r.height*100,8,92),et(e,o,s),at(e)});function n(n){if(!e.grabbed)return;e.grabbed=!1,t.classList.remove(`grabbed`);let r=n;if(r.pointerId!==void 0)try{t.releasePointerCapture(r.pointerId)}catch{}T(e,1,1)}Xe(t,`pointerup`,n),Xe(t,`pointercancel`,n)}function et(e,t,n){let r=Math.min(Math.hypot(t,n)*6,.28),i=Math.atan2(n,t);T(e,1+r*Math.abs(Math.cos(i)),1-r*Math.abs(Math.cos(i))*.6+r*Math.abs(Math.sin(i))*.1)}function tt(e,t){T(e,t,t),window.setTimeout(()=>{e.el.classList.contains(`grabbed`)||T(e,1,1)},160)}function nt(e){e.el.classList.remove(`singt`),e.el.offsetWidth,e.el.classList.add(`singt`),window.setTimeout(()=>e.el.classList.remove(`singt`),300)}function rt(e){e.el.classList.remove(`funkt`),e.el.offsetWidth,e.el.classList.add(`funkt`),window.setTimeout(()=>e.el.classList.remove(`funkt`),420)}function it(e,t){return e<t?`${e}-${t}`:`${t}-${e}`}function at(e){if(!w)return;let t=w.getBoundingClientRect(),n=e.xPct/100*t.width,r=e.yPct/100*t.height;for(let i of Ke){if(i.def.id===e.def.id)continue;let a=i.xPct/100*t.width,o=i.yPct/100*t.height,s=Math.hypot(n-a,r-o),c=e.def.radiusPx*.75+i.def.radiusPx*.75,l=it(e.def.id,i.def.id);s<c?Je.has(l)||(Je.add(l),f({freq:d[e.def.note%d.length],duration:.25,gain:.22}),f({freq:d[i.def.note%d.length],duration:.25,gain:.22}),tt(i,1.1),rt(e),rt(i)):Je.delete(l)}}function ot(){qe.forEach(e=>e()),qe=[],Ye?.disconnect(),Ye=null,Ke=[],w=null,Je=new Set}var st={id:`kleckse`,accent:`#e88a9a`,tileIcon:We,mount:Qe,unmount:ot},ct=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
  ...
  <circle cx="70" cy="40" r="8" fill="#e88a9a"/>
</svg>`,lt=[`#e88a9a`,`#7fb99e`,`#f4c86b`,`#7ea3c9`,`#e0a458`,`#6b5d4a`],ut=`malen`,dt=1,E=null,D=null,O=null,ft=lt[0],pt=!1,mt=0,ht=0,gt=[],k=null,_t=null;function A(e,t,n){e.addEventListener(t,n),gt.push(()=>e.removeEventListener(t,n))}function vt(e){gt=[],pt=!1,ft=lt[0],e.innerHTML=`
    <div class="malen-stage" id="malenStage">
      ...
      <div class="malen-palette" id="malenPalette">
        ${lt.map((e,t)=>`<button class="malen-swatch${t===0?` selected`:``}" data-color="${e}" style="--swatch-color:${e}" aria-hidden="true"></button>`).join(``)}
      </div>
  ...
  `,O=e.querySelector(`#malenStage`),E=e.querySelector(`#malenCanvas`),D=E.getContext(`2d`),yt(),bt(),A(E,`pointerdown`,Ct),A(E,`pointermove`,wt),A(E,`pointerup`,Tt),A(E,`pointercancel`,Tt);let t=e.querySelectorAll(`.malen-swatch`);t.forEach(e=>{A(e,`pointerdown`,n=>{n.preventDefault(),ft=e.dataset.color??lt[0],t.forEach(e=>e.classList.remove(`selected`)),e.classList.add(`selected`),p(500)})}),A(e.querySelector(`#malenNewSheet`),`pointerdown`,e=>{e.preventDefault(),Et()});let n=O.clientWidth,r=O.clientHeight,i=()=>{if(!O)return;let e=O.clientWidth,t=O.clientHeight;(e!==n||t!==r)&&(n=e,r=t,k!==null&&window.clearTimeout(k),k=window.setTimeout(()=>{yt(),bt()},200))};_t=new ResizeObserver(i),_t.observe(O),A(window,`resize`,i),A(window,`orientationchange`,i)}function yt(){if(!E||!O)return;let e=Math.min(window.devicePixelRatio||1,2),t={width:O.clientWidth,height:O.clientHeight};E.width=Math.round(t.width*e),E.height=Math.round(t.height*e),E.style.width=`${t.width}px`,E.style.height=`${t.height}px`,D=E.getContext(`2d`),D&&(D.scale(e,e),D.lineCap=`round`,D.lineJoin=`round`,D.lineWidth=22)}function bt(){let e=g(ut,dt,{dataUrl:null});if(!e.dataUrl||!E||!D)return;let t=new Image;t.onload=()=>{if(!D||!E)return;let e=Math.min(window.devicePixelRatio||1,2);D.drawImage(t,0,0,E.width/e,E.height/e)},t.src=e.dataUrl}function xt(){if(E)try{_(ut,dt,{dataUrl:E.toDataURL(`image/png`)})}catch{}}function St(e){let t=E,n=t.getBoundingClientRect(),r=n.width===0?1:t.clientWidth/n.width,i=n.height===0?1:t.clientHeight/n.height;return{x:(e.clientX-n.left)*r,y:(e.clientY-n.top)*i}}function Ct(e){let t=e;if(t.preventDefault(),!E||!D)return;try{E.setPointerCapture(t.pointerId)}catch{}pt=!0;let{x:n,y:r}=St(t);mt=n,ht=r,D.strokeStyle=ft,D.fillStyle=ft,D.beginPath(),D.arc(n,r,D.lineWidth/2,0,Math.PI*2),D.fill()}function wt(e){if(!pt||!D)return;let{x:t,y:n}=St(e);D.beginPath(),D.moveTo(mt,ht),D.lineTo(t,n),D.stroke(),mt=t,ht=n}function Tt(e){if(!pt)return;pt=!1;let t=e;if(E&&t.pointerId!==void 0)try{E.releasePointerCapture(t.pointerId)}catch{}xt()}function Et(){if(!E||!D||!O)return;let e=E.toDataURL(`image/png`),t=document.createElement(`img`);t.src=e,t.className=`malen-crumple-overlay`,t.style.width=E.style.width,t.style.height=E.style.height,O.appendChild(t);let n=Math.min(window.devicePixelRatio||1,2);D.clearRect(0,0,E.width/n,E.height/n),_(ut,dt,{dataUrl:null}),p(300),t.offsetWidth,t.classList.add(`crumpling`),window.setTimeout(()=>{t.remove()},550)}function Dt(){gt.forEach(e=>e()),gt=[],_t?.disconnect(),_t=null,k!==null&&(window.clearTimeout(k),k=null),E=null,D=null,O=null}var Ot={id:`malen`,accent:`#7ea3c9`,tileIcon:ct,mount:vt,unmount:Dt},kt=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
...
</svg>`,j=[{id:`kreis`,color:`#e88a9a`,note:0,restX:14,restY:80,path:`<circle cx="50" cy="50" r="42"/>`,svg:`<svg viewBox="0 0 100 100"><circle cx="50" cy="50" r="42" fill="#e88a9a"/><circle cx="38" cy="46" r="5" fill="#4a4032"/><circle cx="62" cy="46" r="5" fill="#4a4032"/><path d="M38 60 Q50 68 62 60" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/></svg>`},{id:`quadrat`,color:`#7fb99e`,note:2,restX:33,restY:88,path:`<rect x="8" y="8" width="84" height="84" rx="16"/>`,svg:`<svg viewBox="0 0 100 100"><rect x="8" y="8" width="84" height="84" rx="16" fill="#7fb99e"/><circle cx="38" cy="46" r="5" fill="#4a4032"/><circle cx="62" cy="46" r="5" fill="#4a4032"/><path d="M38 60 Q50 68 62 60" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/></svg>`},{id:`dreieck`,color:`#f4c86b`,note:4,restX:52,restY:80,path:`<path d="M50 10 L92 88 L8 88 Z" stroke-linejoin="round"/>`,svg:`<svg viewBox="0 0 100 100"><path d="M50 10 L92 88 L8 88 Z" fill="#f4c86b" stroke-linejoin="round"/><circle cx="40" cy="66" r="4.5" fill="#4a4032"/><circle cx="60" cy="66" r="4.5" fill="#4a4032"/><path d="M40 76 Q50 82 60 76" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/></svg>`},{id:`stern`,color:`#7ea3c9`,note:5,restX:71,restY:88,path:`<path d="M50 6 L62 37 L96 37 L68 57 L79 90 L50 70 L21 90 L32 57 L4 37 L38 37 Z"/>`,svg:`<svg viewBox="0 0 100 100"><path d="M50 6 L62 37 L96 37 L68 57 L79 90 L50 70 L21 90 L32 57 L4 37 L38 37 Z" fill="#7ea3c9"/><circle cx="42" cy="48" r="4" fill="#4a4032"/><circle cx="58" cy="48" r="4" fill="#4a4032"/><path d="M42 58 Q50 63 58 58" stroke="#4a4032" stroke-width="2.5" fill="none" stroke-linecap="round"/></svg>`},{id:`herz`,color:`#c896d8`,note:7,restX:88,restY:78,path:`<path d="M50 92 C20 67 4 46 4 28 C4 12 17 2 32 2 C42 2 48 9 50 16 C52 9 58 2 68 2 C83 2 96 12 96 28 C96 46 80 67 50 92 Z"/>`,svg:`<svg viewBox="0 0 100 100"><path d="M50 92 C20 67 4 46 4 28 C4 12 17 2 32 2 C42 2 48 9 50 16 C52 9 58 2 68 2 C83 2 96 12 96 28 C96 46 80 67 50 92 Z" fill="#c896d8"/><circle cx="40" cy="34" r="4.5" fill="#4a4032"/><circle cx="60" cy="34" r="4.5" fill="#4a4032"/><path d="M40 44 Q50 50 60 44" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/></svg>`}],At=`sortierer`,jt=1;function Mt(){return j.map(e=>({id:e.id,xPct:e.restX,yPct:e.restY,placed:!1}))}var Nt={shapes:Mt()},M=null,Pt=[],Ft=null,It=new Map;function Lt(e,t,n){e.addEventListener(t,n),Pt.push(()=>e.removeEventListener(t,n))}function N(e){return Nt.shapes.find(t=>t.id===e)??{id:e,xPct:50,yPct:80,placed:!1}}function Rt(){_(At,jt,Nt)}function zt(e){Pt=[],It=new Map;let t=g(At,jt,{shapes:Mt()});Nt={shapes:j.map(e=>t.shapes.find(t=>t.id===e.id)??{id:e.id,xPct:e.restX,yPct:e.restY,placed:!1})},e.innerHTML=`
  ...
  `,M=e.querySelector(`.sorter-stage`),j.forEach(t=>{let n=e.querySelector(`.sorter-form[data-shape="${t.id}"]`),r=e.querySelector(`.sorter-hole[data-hole="${t.id}"]`),i=e.querySelector(`.hole-fuellung[data-fill="${t.id}"]`);It.set(t.id,n),Vt(t.id,i),P(t.id),Ht(t,n),Ut(t,r,n,i)}),Ft=new ResizeObserver(()=>{j.forEach(e=>{(!Bt||Bt!==e.id)&&P(e.id)})}),Ft.observe(M)}var Bt=null;function P(e,t=0,n=0){let r=It.get(e);if(!r||!M)return;let i=M.getBoundingClientRect(),a=N(e),o=r.offsetWidth/2,s=r.offsetHeight/2,c=a.xPct/100*i.width-o+t,l=a.yPct/100*i.height-s+n;r.style.transform=`translate(${c.toFixed(1)}px, ${l.toFixed(1)}px)`}function Vt(e,t){let n=N(e);It.get(e)?.classList.toggle(`versteckt`,n.placed),t.classList.toggle(`gefuellt`,n.placed)}function Ht(e,t){let n=!1,r=0,i=0,a=0;Lt(t,`pointerdown`,o=>{let s=o;if(s.preventDefault(),!N(e.id).placed){n=!0,Bt=e.id,r=0,i=s.clientX,a=s.clientY,t.classList.add(`greift`);try{t.setPointerCapture(s.pointerId)}catch{}}}),Lt(t,`pointermove`,t=>{if(!n||!M)return;let o=t,s=o.clientX-i,c=o.clientY-a;r=Math.max(r,Math.hypot(s,c)),P(e.id,s,c)});let o=i=>{if(!n)return;n=!1,Bt=null;let a=i;t.classList.remove(`greift`);try{t.releasePointerCapture(a.pointerId)}catch{}if(r<6){P(e.id),Kt(t),p(420),Rt();return}if(M){let t=M.getBoundingClientRect(),n=N(e.id);n.xPct=qt((a.clientX-t.left)/t.width*100,3,97),n.yPct=qt((a.clientY-t.top)/t.height*100,3,97)}P(e.id);let o=M?.querySelector(`.sorter-hole[data-hole="${e.id}"]`);if(o&&M){let t=o.getBoundingClientRect(),n=t.left+t.width/2,r=t.top+t.height/2;if(Math.hypot(a.clientX-n,a.clientY-r)<60){let t=M.querySelector(`.hole-fuellung[data-fill="${e.id}"]`),n=N(e.id);n.placed=!0,Vt(e.id,t),Wt(t,e.note),Rt();return}}Rt()};Lt(t,`pointerup`,o),Lt(t,`pointercancel`,o)}function Ut(e,t,n,r){Lt(t,`pointerdown`,t=>{let i=N(e.id);i.placed&&(t.preventDefault(),i.placed=!1,i.xPct=e.restX,i.yPct=e.restY,Vt(e.id,r),P(e.id),Gt(n),f({freq:d[e.note%d.length]*1.5,duration:.18,attack:.005,release:.25,type:`triangle`,gain:.24}),Rt())})}function Wt(e,t){e.classList.remove(`plumpst`),e.offsetWidth,e.classList.add(`plumpst`),f({freq:d[t%d.length],duration:.22,attack:.004,release:.3,type:`sine`,gain:.32}),window.setTimeout(()=>e.classList.remove(`plumpst`),400)}function Gt(e){let t=e.querySelector(`.sorter-form-fx`);t&&(t.classList.remove(`huepft`),t.offsetWidth,t.classList.add(`huepft`),window.setTimeout(()=>t.classList.remove(`huepft`),500))}function Kt(e){let t=e.querySelector(`.sorter-form-fx`);t&&(t.classList.remove(`wackelt`),t.offsetWidth,t.classList.add(`wackelt`),window.setTimeout(()=>t.classList.remove(`wackelt`),400))}function qt(e,t,n){return Math.max(t,Math.min(n,e))}function Jt(){Pt.forEach(e=>e()),Pt=[],Ft?.disconnect(),Ft=null,It=new Map,M=null,Bt=null,Nt={shapes:Mt()}}var Yt={id:`sortierer`,accent:`#e0a458`,tileIcon:kt,mount:zt,unmount:Jt},Xt=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
...
</svg>`,Zt=[`rgba(126, 200, 216, 0.55)`,`rgba(200, 182, 224, 0.55)`,`rgba(244, 200, 107, 0.45)`,`rgba(232, 138, 154, 0.45)`,`rgba(127, 185, 158, 0.5)`],Qt=14,$t=900,F=null,en=[],I=null,tn=[];function nn(e,t,n){e.addEventListener(t,n),en.push(()=>e.removeEventListener(t,n))}function rn(e){en=[],tn=[],e.innerHTML=`
...
<svg viewBox="0 0 120 120" width="100%" height="100%">
  ...
  <circle cx="84" cy="92" r="13" fill="#7ec8d8"/>
    ...
    </svg>`,dirt:`#7d6b52`,fleck:`#5f5040`}],dn=34,fn=.82,L=null,R=null,z=null,pn=0,mn=!1,hn=[],B=null,gn=null,_n=[],V=new Map;function H(e,t,n){e.addEventListener(t,n),hn.push(()=>e.removeEventListener(t,n))}function vn(e){hn=[],V.clear(),_n=[],pn=0,mn=!1,e.innerHTML=`
  ...
  `,z=e.querySelector(`#putzenStage`),L=e.querySelector(`#putzenCanvas`),yn(e,0),H(L,`pointerdown`,Cn),H(L,`pointermove`,wn),H(L,`pointerup`,Tn),H(L,`pointercancel`,Tn),H(e.querySelector(`#putzenNext`),`pointerdown`,t=>{t.preventDefault(),yn(e,pn+1),h()});let t=z.clientWidth,n=z.clientHeight,r=()=>{if(!z)return;let e=z.clientWidth,r=z.clientHeight;(e!==t||r!==n)&&(t=e,n=r,B!==null&&window.clearTimeout(B),B=window.setTimeout(()=>bn(),220))};gn=new ResizeObserver(r),gn.observe(z),H(window,`resize`,r),H(window,`orientationchange`,r)}function yn(e,t){pn=(t%un.length+un.length)%un.length,mn=!1,z?.classList.remove(`sauber`);let n=e.querySelector(`#putzenMotiv`);n.innerHTML=un[pn].clean,bn()}function bn(){if(!L||!z)return;let e=Math.min(window.devicePixelRatio||1,2),t=z.clientWidth,n=z.clientHeight;L.width=Math.round(t*e),L.height=Math.round(n*e),L.style.width=`${t}px`,L.style.height=`${n}px`,R=L.getContext(`2d`,{willReadFrequently:!0}),R&&(R.scale(e,e),xn(t,n))}function xn(e,t){if(!R)return;let n=un[pn];R.globalCompositeOperation=`source-over`,R.clearRect(0,0,e,t),R.fillStyle=n.dirt,R.fillRect(0,0,e,t),R.fillStyle=n.fleck;for(let n=0;n<140;n++){let n=Math.random()*e,r=Math.random()*t,i=6+Math.random()*26;R.globalAlpha=.18+Math.random()*.3,R.beginPath(),R.ellipse(n,r,i,i*(.6+Math.random()*.7),Math.random()*Math.PI,0,Math.PI*2),R.fill()}R.globalAlpha=1}function Sn(e){let t=L,n=t.getBoundingClientRect(),r=n.width===0?1:t.clientWidth/n.width,i=n.height===0?1:t.clientHeight/n.height;return{x:(e.clientX-n.left)*r,y:(e.clientY-n.top)*i}}function Cn(e){let t=e;if(t.preventDefault(),!L||!R)return;try{L.setPointerCapture(t.pointerId)}catch{}let n=Sn(t);V.set(t.pointerId,n),En(n.x,n.y),kn()}function wn(e){let t=e,n=V.get(t.pointerId);if(!n||!R)return;let r=Sn(t);Dn(n.x,n.y,r.x,r.y),V.set(t.pointerId,r),kn()}function Tn(e){let t=e;if(V.has(t.pointerId)){if(V.delete(t.pointerId),L)try{L.releasePointerCapture(t.pointerId)}catch{}jn()}}function En(e,t){R&&(R.globalCompositeOperation=`destination-out`,R.beginPath(),R.arc(e,t,dn,0,Math.PI*2),R.fill())}function Dn(e,t,n,r){R&&(R.globalCompositeOperation=`destination-out`,R.lineCap=`round`,R.lineJoin=`round`,R.lineWidth=68,R.beginPath(),R.moveTo(e,t),R.lineTo(n,r),R.stroke())}var On=0;function kn(){let e=performance.now();e-On<130||(On=e,f({freq:180+Math.random()*90,duration:.05,attack:.01,release:.1,type:`triangle`,gain:.07}))}function An(){if(!L||!R)return 0;let e=0,t=0,n=L.width/24,r=L.height/24;for(let i=0;i<24;i++)for(let a=0;a<24;a++){let o=Math.min(L.width-1,Math.floor(i*n+n/2)),s=Math.min(L.height-1,Math.floor(a*r+r/2));R.getImageData(o,s,1,1).data[3]<40&&e++,t++}return t===0?0:e/t}function jn(){if(!mn&&!(An()<fn)){if(mn=!0,R&&L){let e=Math.min(window.devicePixelRatio||1,2);R.globalCompositeOperation=`destination-out`,R.fillStyle=`#000`,R.fillRect(0,0,L.width/e,L.height/e)}z?.classList.add(`sauber`),[0,130,260].forEach((e,t)=>{let n=window.setTimeout(()=>{f({freq:d[t+3],duration:.3,attack:.01,release:.5,gain:.24})},e);_n.push(n)})}}function Mn(){hn.forEach(e=>e()),hn=[],gn?.disconnect(),gn=null,B!==null&&(window.clearTimeout(B),B=null),_n.forEach(e=>window.clearTimeout(e)),_n=[],V.clear(),L=null,R=null,z=null}var Nn={id:`putzen`,accent:`#7ec8d8`,tileIcon:ln,mount:vn,unmount:Mn},Pn=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
  ...
  `,zn=e.querySelector(`#stickerStage`),W=e.querySelector(`#stickerSzene`),G=e.querySelector(`#stickerTray`),Gn(),qn(e),G.querySelectorAll(`.tray-item`).forEach(e=>{Vn(e,`pointerdown`,t=>Zn(t,e))})}function Gn(){let e=document.getElementById(`stickerPlatziert`);e&&(e.innerHTML=``,U.forEach((t,n)=>{let r=Hn(t.art),i=document.createElement(`div`);i.className=`sticker`,i.dataset.index=String(n),i.style.width=`${r.size}px`,i.style.height=`${r.size}px`,i.style.left=`${t.xPct}%`,i.style.top=`${t.yPct}%`,i.style.setProperty(`--rot`,`${t.rot}deg`),i.innerHTML=r.svg,e.appendChild(i),Kn(i,n)}))}function Kn(e,t){let n=!1,r=0,i=0,a=0;e.addEventListener(`pointerdown`,t=>{t.preventDefault(),t.stopPropagation(),n=!0,r=0,i=t.clientX,a=t.clientY,e.classList.add(`greift`);try{e.setPointerCapture(t.pointerId)}catch{}}),e.addEventListener(`pointermove`,o=>{if(!n||!W)return;r=Math.max(r,Math.hypot(o.clientX-i,o.clientY-a));let s=W.getBoundingClientRect(),c=U[t];c&&(c.xPct=Xn((o.clientX-s.left)/s.width*100,2,98),c.yPct=Xn((o.clientY-s.top)/s.height*100,2,98),e.style.left=`${c.xPct}%`,e.style.top=`${c.yPct}%`)});let o=i=>{if(n){n=!1,e.classList.remove(`greift`);try{e.releasePointerCapture(i.pointerId)}catch{}if(G&&Yn(i.clientX,i.clientY)){U.splice(t,1),Un(),Gn(),p(300);return}r<10&&(e.classList.remove(`wackelt`),e.offsetWidth,e.classList.add(`wackelt`),f({freq:d[Hn(U[t]?.art??Fn[0].id).note%d.length],duration:.3,gain:.28})),Un()}};e.addEventListener(`pointerup`,o),e.addEventListener(`pointercancel`,o)}function qn(e){Vn(e.querySelector(`#stickerClear`),`pointerdown`,e=>{e.preventDefault(),U.length!==0&&Jn()})}function Jn(){let e=document.getElementById(`stickerPlatziert`);if(!e)return;let t=[...e.querySelectorAll(`.sticker`)];t.forEach((e,t)=>{e.style.transitionDelay=`${Math.min(t*25,500)}ms`,e.offsetWidth,e.classList.add(`wegfegen`)}),h(),window.setTimeout(()=>{U=[],Un(),Gn()},500+Math.min(t.length*25,500))}function Yn(e,t){if(!G)return!1;let n=G.getBoundingClientRect();return e>=n.left&&e<=n.right&&t>=n.top&&t<=n.bottom}function Xn(e,t,n){return Math.max(t,Math.min(n,e))}function Zn(e,t){if(e.preventDefault(),!zn)return;let n=Hn(t.dataset.art??``);try{t.setPointerCapture(e.pointerId)}catch{}let r=document.createElement(`div`);r.className=`sticker-ghost`,r.style.width=`${n.size}px`,r.style.height=`${n.size}px`,r.innerHTML=n.svg,zn.appendChild(r);let i=(e,t)=>{let n=zn.getBoundingClientRect();r.style.left=`${e-n.left}px`,r.style.top=`${t-n.top}px`};i(e.clientX,e.clientY),p(560);let a=!1;function o(e){let t=e;i(t.clientX,t.clientY)}function s(e){if(a)return;a=!0;let i=e;try{t.releasePointerCapture(i.pointerId)}catch{}t.removeEventListener(`pointermove`,o),t.removeEventListener(`pointerup`,s),t.removeEventListener(`pointercancel`,s),r.remove(),Qn(n,i.clientX,i.clientY)}t.addEventListener(`pointermove`,o),t.addEventListener(`pointerup`,s),t.addEventListener(`pointercancel`,s)}function Qn(e,t,n){if(!W||Yn(t,n))return;let r=W.getBoundingClientRect();n>r.bottom||n<r.top||(U.length>=Rn&&U.shift(),U.push({art:e.id,xPct:Xn((t-r.left)/r.width*100,2,98),yPct:Xn((n-r.top)/r.height*100,2,98),rot:Math.round((Math.random()*2-1)*9)}),Un(),Gn(),f({freq:d[e.note%d.length],duration:.28,gain:.3}))}function $n(){Bn.forEach(e=>e()),Bn=[],U=[],zn=null,W=null,G=null}var er={id:`sticker`,accent:`#9ec99f`,tileIcon:Pn,mount:Wn,unmount:$n},tr=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
...
</svg>`,nr=`wimmelbild`,rr=1,ir={tuerOffen:!1,vorhangOffen:!1,flaggeOben:!1},K={...ir},ar=[],or=[],q=new Set;function sr(e,t,n){e.addEventListener(t,n),ar.push(()=>e.removeEventListener(t,n))}function cr(){_(nr,rr,K)}function J(e,t){let n=window.setTimeout(e,t);or.push(n)}function Y(e,t,n){let r=e.querySelector(t),i=t;sr(r,`pointerdown`,e=>{e.preventDefault(),!q.has(i)&&(q.add(i),r.classList.remove(n.className),r.offsetWidth,r.classList.add(n.className),n.onTrigger?.(r),n.sound?.(),J(()=>{r.classList.remove(n.className),q.delete(i)},n.duration))})}function lr(e){K=g(nr,rr,{...ir}),ar=[],or=[],q=new Set,e.innerHTML=`
  ...
  `,ur(e),dr(e),fr(e),pr(e),mr(e),hr(e),gr(e),_r(e),vr(e),yr(e),br(e),xr(e),Sr(e),Cr(e)}function ur(e){Y(e,`.w-sonne`,{className:`strahlt`,duration:700,sound:()=>{f({freq:1046.5,duration:.35,attack:.01,release:.5,type:`sine`,gain:.22}),f({freq:1567.98,duration:.25,attack:.01,release:.4,type:`sine`,gain:.1})}})}function dr(e){Y(e,`.w-wolke`,{className:`zieht-vorbei`,duration:2400,sound:()=>h()})}function fr(e){Y(e,`.w-schornstein`,{className:`pufft`,duration:1400,sound:()=>f({freq:260,duration:.15,attack:.01,release:.3,type:`sine`,gain:.16})})}function pr(e){let t=e.querySelector(`.w-tuer`);t.classList.toggle(`offen`,K.tuerOffen),sr(t,`pointerdown`,e=>{e.preventDefault(),K.tuerOffen=!K.tuerOffen,t.classList.toggle(`offen`,K.tuerOffen),h(),K.tuerOffen&&(f({freq:587.33,duration:.12,attack:.005,release:.15,type:`triangle`,gain:.2}),J(()=>f({freq:493.88,duration:.18,attack:.005,release:.25,type:`triangle`,gain:.2}),130)),cr()})}function mr(e){let t=e.querySelector(`.w-fenster`);t.classList.toggle(`offen`,K.vorhangOffen),sr(t,`pointerdown`,e=>{e.preventDefault(),K.vorhangOffen=!K.vorhangOffen,t.classList.toggle(`offen`,K.vorhangOffen),h(),cr()})}function hr(e){Y(e,`.w-apfel`,{className:`faellt`,duration:900,sound:()=>f({freq:220,duration:.09,attack:.004,release:.14,type:`sine`,gain:.28})})}function gr(e){Y(e,`.w-vogelhaus`,{className:`fliegt`,duration:1600,sound:()=>{[0,90,180].forEach((e,t)=>{J(()=>f({freq:d[(4+t)%d.length],duration:.14,attack:.005,release:.2,type:`triangle`,gain:.22}),e)})}})}function _r(e){let t=e.querySelector(`.w-schaukel`),n=t.querySelector(`.schaukel-sitz`),r=`schaukel`;sr(t,`pointerdown`,e=>{e.preventDefault(),!q.has(r)&&(q.add(r),n.classList.remove(`schwingt`),n.offsetWidth,n.classList.add(`schwingt`),[0,350,700,1050].forEach(e=>{J(()=>f({freq:380,duration:.05,attack:.005,release:.1,type:`sine`,gain:.1}),e)}),J(()=>{n.classList.remove(`schwingt`),q.delete(r)},2200))})}function vr(e){Y(e,`.w-biene`,{className:`summt`,duration:1300,sound:()=>f({freq:660,duration:.5,attack:.02,release:.4,type:`sawtooth`,gain:.06})})}function yr(e){Y(e,`.w-maulwurfshuegel`,{className:`guckt`,duration:1200,sound:()=>f({freq:180,duration:.12,attack:.005,release:.2,type:`sine`,gain:.24})})}function br(e){let t=e.querySelector(`.w-briefkasten`);t.classList.toggle(`offen`,K.flaggeOben),sr(t,`pointerdown`,e=>{e.preventDefault(),K.flaggeOben=!K.flaggeOben,t.classList.toggle(`offen`,K.flaggeOben),p(K.flaggeOben?700:500),cr()})}function xr(e){Y(e,`.w-frosch`,{className:`huepft`,duration:700,sound:()=>f({freq:200,duration:.1,attack:.004,release:.16,type:`square`,gain:.18})})}function Sr(e){Y(e,`.w-schnecke`,{className:`streckt`,duration:900,sound:()=>p(520)})}function Cr(e){Y(e,`.w-marienkaefer`,{className:`fliegt-los`,duration:1100,sound:()=>f({freq:900,duration:.3,attack:.02,release:.3,type:`sawtooth`,gain:.05})})}function wr(){ar.forEach(e=>e()),ar=[],or.forEach(e=>window.clearTimeout(e)),or=[],q=new Set}var Tr={id:`wimmelbild`,accent:`#9ec99f`,tileIcon:tr,mount:lr,unmount:wr},Er=`
<svg viewBox="0 0 120 120" width="100%" height="100%">
...
</svg>`,Dr=[{id:`baer`,bettFarbe:`#e0a458`,wach:`<svg viewBox="0 0 100 100"><circle cx="50" cy="58" r="30" fill="#c9a37e"/><circle cx="24" cy="34" r="12" fill="#c9a37e"/><circle cx="76" cy="34" r="12" fill="#c9a37e"/><circle cx="40" cy="56" r="4" fill="#4a4032"/><circle cx="60" cy="56" r="4" fill="#4a4032"/><ellipse cx="50" cy="68" rx="8" ry="5" fill="#8a7255"/></svg>`,schlaeft:`<svg viewBox="0 0 100 100"><circle cx="50" cy="58" r="30" fill="#c9a37e"/><circle cx="24" cy="34" r="12" fill="#c9a37e"/><circle cx="76" cy="34" r="12" fill="#c9a37e"/><path d="M34 56 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M54 56 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><ellipse cx="50" cy="68" rx="8" ry="5" fill="#8a7255"/></svg>`},{id:`hase`,bettFarbe:`#e88a9a`,wach:`<svg viewBox="0 0 100 100"><ellipse cx="50" cy="62" rx="26" ry="26" fill="#f3e7db"/><ellipse cx="38" cy="24" rx="8" ry="20" fill="#f3e7db"/><ellipse cx="62" cy="24" rx="8" ry="20" fill="#f3e7db"/><ellipse cx="38" cy="26" rx="4" ry="13" fill="#f2b8c6"/><ellipse cx="62" cy="26" rx="4" ry="13" fill="#f2b8c6"/><circle cx="41" cy="58" r="4" fill="#4a4032"/><circle cx="59" cy="58" r="4" fill="#4a4032"/><ellipse cx="50" cy="68" rx="5" ry="3.5" fill="#e88a9a"/></svg>`,schlaeft:`<svg viewBox="0 0 100 100"><ellipse cx="50" cy="62" rx="26" ry="26" fill="#f3e7db"/><ellipse cx="38" cy="24" rx="8" ry="20" fill="#f3e7db"/><ellipse cx="62" cy="24" rx="8" ry="20" fill="#f3e7db"/><ellipse cx="38" cy="26" rx="4" ry="13" fill="#f2b8c6"/><ellipse cx="62" cy="26" rx="4" ry="13" fill="#f2b8c6"/><path d="M35 58 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M53 58 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><ellipse cx="50" cy="68" rx="5" ry="3.5" fill="#e88a9a"/></svg>`},{id:`katze`,bettFarbe:`#7ea3c9`,wach:`<svg viewBox="0 0 100 100"><ellipse cx="50" cy="60" rx="26" ry="24" fill="#e0a458"/><path d="M28 44 L18 20 L38 36 Z" fill="#e0a458"/><path d="M72 44 L82 20 L62 36 Z" fill="#e0a458"/><circle cx="40" cy="58" r="4" fill="#4a4032"/><circle cx="60" cy="58" r="4" fill="#4a4032"/><path d="M42 68 Q50 73 58 68" stroke="#8a5a2e" stroke-width="2.5" fill="none" stroke-linecap="round"/></svg>`,schlaeft:`<svg viewBox="0 0 100 100"><ellipse cx="50" cy="60" rx="26" ry="24" fill="#e0a458"/><path d="M28 44 L18 20 L38 36 Z" fill="#e0a458"/><path d="M72 44 L82 20 L62 36 Z" fill="#e0a458"/><path d="M34 58 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M54 58 q6 5 12 0" stroke="#4a4032" stroke-width="3" fill="none" stroke-linecap="round"/><path d="M42 68 Q50 71 58 68" stroke="#8a5a2e" stroke-width="2.5" fill="none" stroke-linecap="round"/></svg>`}],Or=`gutenacht`,kr=1,Ar={lampeAn:!0,schlaeft:[!1,!1,!1]},X={...Ar},jr=[];function Mr(e,t,n){e.addEventListener(t,n),jr.push(()=>e.removeEventListener(t,n))}function Nr(){_(Or,kr,X)}function Pr(e){X=g(Or,kr,{...Ar,schlaeft:[...Ar.schlaeft]}),jr=[],e.innerHTML=`
  ...
  `;let t=e.querySelector(`#nachtSzene`);t.classList.toggle(`dunkel`,!X.lampeAn),Fr(e,t),Ir(e)}function Fr(e,t){Mr(e.querySelector(`.n-lampe`),`pointerdown`,e=>{e.preventDefault(),X.lampeAn=!X.lampeAn,t.classList.toggle(`dunkel`,!X.lampeAn),f({freq:X.lampeAn?480:320,duration:.18,attack:.01,release:.3,type:`sine`,gain:.18}),Nr()})}function Ir(e){e.querySelectorAll(`.n-tier`).forEach(e=>{let t=Number(e.dataset.idx);Mr(e,`pointerdown`,n=>{n.preventDefault();let r=!X.schlaeft[t];X.schlaeft[t]=r,e.classList.toggle(`schlaeft`,r),e.closest(`.n-bett`)?.classList.toggle(`schlaeft`,r),r?(h(),f({freq:392,duration:.2,attack:.01,release:.4,type:`sine`,gain:.16}),window.setTimeout(()=>{f({freq:294,duration:.3,attack:.01,release:.5,type:`sine`,gain:.14})},220)):(f({freq:440,duration:.1,attack:.005,release:.2,type:`triangle`,gain:.2}),window.setTimeout(()=>{f({freq:587.33,duration:.16,attack:.005,release:.25,type:`triangle`,gain:.2})},110)),Nr()})})}function Lr(){jr.forEach(e=>e()),jr=[],X={...Ar,schlaeft:[...Ar.schlaeft]}}var Rr={id:`gutenacht`,accent:`#7ea3c9`,tileIcon:Er,mount:Pr,unmount:Lr};se();var zr=[Ue,st,Ot,Yt,cn,Nn,er,Tr,Rr],Br=document.querySelector(`#app`),Vr=`
  <svg viewBox="0 0 96 96" width="40" height="40">
    <path d="M56 26 L34 48 L56 70" fill="none" stroke="#8a7255" stroke-width="8"
      stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
`,Hr=18,Ur=2*Math.PI*Hr;Br.innerHTML=`
  ...
  <svg viewBox="0 0 44 44">
    ...
    <circle class="eltern-gate-progress" cx="22" cy="22" r="${Hr}" fill="none"
      ...
      stroke-dasharray="${Ur}" stroke-dashoffset="${Ur}"
...
`}</button>
  ...
  <button class="back-button" id="backButton" aria-hidden="true">${Vr}</button>
  <div class="eltern-overlay" id="elternOverlay">
    <div id="elternPanelWrap"></div>
  </div>
  <div class="version-placeholder">v1.0.2 · 5decf79</div>
`;var Wr=document.querySelector(`#spielzimmer`),Gr=document.querySelector(`#tiles`),Kr=document.querySelector(`#toyView`),qr=document.querySelector(`#toyStage`),Jr=document.querySelector(`#backButton`),Z=document.querySelector(`#elternGate`),Yr=document.querySelector(`#elternOverlay`),Xr=document.querySelector(`#elternPanelWrap`),Zr=null,Q=!1;function Qr(){Gr.innerHTML=``,zr.forEach((e,t)=>{let n=document.createElement(`button`);n.className=`tile`,n.style.setProperty(`--accent`,e.accent),n.style.animationDelay=`${(t*.7%4.5).toFixed(2)}s`,n.innerHTML=e.tileIcon,n.setAttribute(`aria-hidden`,`true`),n.addEventListener(`pointerdown`,t=>{t.preventDefault(),$r(e)}),Gr.appendChild(n)})}function $r(e){Q||Zr||(Q=!0,Zr=e,e.mount(qr),Wr.classList.add(`hidden`),Jr.classList.add(`visible`),Kr.classList.add(`active`),window.setTimeout(()=>{Q=!1},450))}function ei(){Q||!Zr||(Q=!0,Kr.classList.remove(`active`),Wr.classList.remove(`hidden`),Jr.classList.remove(`visible`),window.setTimeout(()=>{Zr?.unmount?.(),qr.innerHTML=``,Zr=null,Q=!1},450))}Jr.addEventListener(`pointerdown`,e=>{e.preventDefault(),ei()});var ti=3e3,$=null;function ni(){$===null&&(Z.classList.add(`charging`),$=window.setTimeout(()=>{$=null,Z.classList.remove(`charging`),ii()},ti))}function ri(){$!==null&&(window.clearTimeout($),$=null),Z.classList.remove(`charging`)}Z.addEventListener(`pointerdown`,e=>{e.preventDefault(),ni()}),Z.addEventListener(`pointerup`,ri),Z.addEventListener(`pointercancel`,ri),Z.addEventListener(`pointerleave`,ri);function ii(){le(Xr),Yr.classList.add(`active`)}function ai(){Yr.classList.remove(`active`)}Yr.addEventListener(`pointerdown`,e=>{e.target===Yr&&ai()}),document.addEventListener(`click`,e=>{e.target.closest(`.eltern-close`)&&ai()}),document.addEventListener(`gesturestart`,e=>e.preventDefault()),document.addEventListener(`gesturechange`,e=>e.preventDefault()),document.addEventListener(`dblclick`,e=>e.preventDefault()),document.addEventListener(`contextmenu`,e=>e.preventDefault());var oi=!1;document.addEventListener(`pointerdown`,()=>{o(),oi||(oi=!0,window.setTimeout(()=>{u()&&f({freq:523.25,duration:.15,gain:.25})},80))},{once:!1}),Qr();